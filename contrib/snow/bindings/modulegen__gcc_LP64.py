...
def module_init():
    root_module = Module('ns.snow', cpp_namespace='::ns3')
    return root_module

def register_types(module):
    root_module = module.get_root()
    
    ## snow-mac.h (module 'snow'): ns3::snowTxOption [enumeration]
    module.add_enum('snowTxOption', ['TX_OPTION_NONE', 'TX_OPTION_ACK', 'TX_OPTION_GTS', 'TX_OPTION_INDIRECT'])
    ## snow-mac.h (module 'snow'): ns3::snowMacState [enumeration]
    module.add_enum('snowMacState', ['MAC_IDLE', 'MAC_CSMA', 'MAC_SENDING', 'MAC_ACK_PENDING', 'CHANNEL_ACCESS_FAILURE', 'CHANNEL_IDLE', 'SET_PHY_TX_ON', 'MAC_GTS', 'MAC_INACTIVE', 'MAC_CSMA_DEFERRED'])
    ## snow-mac.h (module 'snow'): ns3::SuperframeStatus [enumeration]
    module.add_enum('SuperframeStatus', ['BEACON', 'CAP', 'CFP', 'INACTIVE'])
    ## snow-mac.h (module 'snow'): ns3::SuperframeType [enumeration]
    module.add_enum('SuperframeType', ['OUTGOING', 'INCOMING'])
    ## snow-mac.h (module 'snow'): ns3::snowAddressMode [enumeration]
    module.add_enum('snowAddressMode', ['NO_PANID_ADDR', 'ADDR_MODE_RESERVED', 'SHORT_ADDR', 'EXT_ADDR'])
    ## snow-mac.h (module 'snow'): ns3::snowAssociationStatus [enumeration]
    module.add_enum('snowAssociationStatus', ['ASSOCIATED', 'PAN_AT_CAPACITY', 'PAN_ACCESS_DENIED', 'ASSOCIATED_WITHOUT_ADDRESS', 'DISASSOCIATED'])
    ## snow-mac.h (module 'snow'): ns3::snowMcpsDataConfirmStatus [enumeration]
    module.add_enum('snowMcpsDataConfirmStatus', ['IEEE_802_15_4_SUCCESS', 'IEEE_802_15_4_TRANSACTION_OVERFLOW', 'IEEE_802_15_4_TRANSACTION_EXPIRED', 'IEEE_802_15_4_CHANNEL_ACCESS_FAILURE', 'IEEE_802_15_4_INVALID_ADDRESS', 'IEEE_802_15_4_INVALID_GTS', 'IEEE_802_15_4_NO_ACK', 'IEEE_802_15_4_COUNTER_ERROR', 'IEEE_802_15_4_FRAME_TOO_LONG', 'IEEE_802_15_4_UNAVAILABLE_KEY', 'IEEE_802_15_4_UNSUPPORTED_SECURITY', 'IEEE_802_15_4_INVALID_PARAMETER'])
    ## snow-mac.h (module 'snow'): ns3::snowMlmeStartConfirmStatus [enumeration]
    module.add_enum('snowMlmeStartConfirmStatus', ['MLMESTART_SUCCESS', 'MLMESTART_NO_SHORT_ADDRESS', 'MLMESTART_SUPERFRAME_OVERLAP', 'MLMESTART_TRACKING_OFF', 'MLMESTART_INVALID_PARAMETER', 'MLMESTART_COUNTER_ERROR', 'MLMESTART_FRAME_TOO_LONG', 'MLMESTART_UNAVAILABLE_KEY', 'MLMESTART_UNSUPPORTED_SECURITY', 'MLMESTART_CHANNEL_ACCESS_FAILURE'])
    ## snow-mac.h (module 'snow'): ns3::snowSyncLossReason [enumeration]
    module.add_enum('snowSyncLossReason', ['MLMESYNCLOSS_PAN_ID_CONFLICT', 'MLMESYNCLOSS_REALIGMENT', 'MLMESYNCLOSS_BEACON_LOST', 'MLMESYNCLOSS_SUPERFRAME_OVERLAP'])
    ## snow-mac.h (module 'snow'): ns3::snowMlmePollConfirmStatus [enumeration]
    module.add_enum('snowMlmePollConfirmStatus', ['MLMEPOLL_SUCCESS', 'MLMEPOLL_CHANNEL_ACCESS_FAILURE', 'MLMEPOLL_NO_ACK', 'MLMEPOLL_NO_DATA', 'MLMEPOLL_COUNTER_ERROR', 'MLMEPOLL_FRAME_TOO_LONG', 'MLMEPOLL_UNAVAILABLE_KEY', 'MLMEPOLL_UNSUPPORTED_SECURITY', 'MLMEPOLL_INVALID_PARAMETER'])
    ## snow-fields.h (module 'snow'): ns3::DeviceType [enumeration]
    module.add_enum('DeviceType', ['RFD', 'FFD'])
    ## snow-phy.h (module 'snow'): ns3::snowPhyOption [enumeration]
    module.add_enum('snowPhyOption', ['IEEE_802_15_4_868MHZ_BPSK', 'IEEE_802_15_4_915MHZ_BPSK', 'IEEE_802_15_4_868MHZ_ASK', 'IEEE_802_15_4_915MHZ_ASK', 'IEEE_802_15_4_868MHZ_OQPSK', 'IEEE_802_15_4_915MHZ_OQPSK', 'IEEE_802_15_4_2_4GHZ_OQPSK', 'IEEE_802_15_4_INVALID_PHY_OPTION'])
    ## snow-phy.h (module 'snow'): ns3::snowPhyEnumeration [enumeration]
    module.add_enum('snowPhyEnumeration', ['IEEE_802_15_4_PHY_BUSY', 'IEEE_802_15_4_PHY_BUSY_RX', 'IEEE_802_15_4_PHY_BUSY_TX', 'IEEE_802_15_4_PHY_FORCE_TRX_OFF', 'IEEE_802_15_4_PHY_IDLE', 'IEEE_802_15_4_PHY_INVALID_PARAMETER', 'IEEE_802_15_4_PHY_RX_ON', 'IEEE_802_15_4_PHY_SUCCESS', 'IEEE_802_15_4_PHY_TRX_OFF', 'IEEE_802_15_4_PHY_TX_ON', 'IEEE_802_15_4_PHY_UNSUPPORTED_ATTRIBUTE', 'IEEE_802_15_4_PHY_READ_ONLY', 'IEEE_802_15_4_PHY_UNSPECIFIED'])
    ## snow-phy.h (module 'snow'): ns3::snowPibAttributeIdentifier [enumeration]
    module.add_enum('snowPibAttributeIdentifier', ['phyCurrentChannel', 'phyChannelsSupported', 'phyTransmitPower', 'phyCCAMode', 'phyCurrentPage', 'phyMaxFrameDuration', 'phySHRDuration', 'phySymbolsPerOctet'])
    ...
    ## default-deleter.h (module 'core'): ns3::DefaultDeleter<ns3::snowInterferenceHelper> [struct]
    module.add_class('DefaultDeleter', template_parameters=['ns3::snowInterferenceHelper'])
    ...
    ## snow-fields.h (module 'snow'): ns3::GtsFields [class]
    ...
    typehandlers.add_type_alias('std::map< std::string, ns3::LogComponent * >*', 'ns3::LogComponent::ComponentList*')
    typehandlers.add_type_alias('std::map< std::string, ns3::LogComponent * >&', 'ns3::LogComponent::ComponentList&')
    ## snow-phy.h (module 'snow'): ns3::snowEdPower [struct]
    module.add_class('snowEdPower')
    ## snow-phy.h (module 'snow'): ns3::snowPhyDataAndSymbolRates [struct]
    module.add_class('snowPhyDataAndSymbolRates')
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes [struct]
    module.add_class('snowPhyPibAttributes')
    ## snow-phy.h (module 'snow'): ns3::snowPhyPpduHeaderSymbolNumber [struct]
    module.add_class('snowPhyPpduHeaderSymbolNumber')
    ## snow-spectrum-value-helper.h (module 'snow'): ns3::snowSpectrumValueHelper [class]
    module.add_class('snowSpectrumValueHelper')
    ...
    ## snow-mac.h (module 'snow'): ns3::McpsDataConfirmParams [struct]
    module.add_class('McpsDataConfirmParams')
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams [struct]
    module.add_class('McpsDataIndicationParams')
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams [struct]
    module.add_class('McpsDataRequestParams')
    ## snow-mac.h (module 'snow'): ns3::MlmeBeaconNotifyIndicationParams [struct]
    module.add_class('MlmeBeaconNotifyIndicationParams')
    ## snow-mac.h (module 'snow'): ns3::MlmePollConfirmParams [struct]
    module.add_class('MlmePollConfirmParams')
    ## snow-mac.h (module 'snow'): ns3::MlmePollRequestParams [struct]
    module.add_class('MlmePollRequestParams')
    ## snow-mac.h (module 'snow'): ns3::MlmeStartConfirmParams [struct]
    module.add_class('MlmeStartConfirmParams')
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams [struct]
    module.add_class('MlmeStartRequestParams')
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncLossIndicationParams [struct]
    module.add_class('MlmeSyncLossIndicationParams')
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncRequestParams [struct]
    ...
    ## snow-fields.h (module 'snow'): ns3::PendingAddrFields [class]
    ...
    ## snow-fields.h (module 'snow'): ns3::SuperframeField [class]
    ...
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowMacState> [class]
    module.add_class('TracedValue', import_from_module='ns.core', template_parameters=['ns3::snowMacState'])
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowPhyEnumeration> [class]
    module.add_class('TracedValue', import_from_module='ns.core', template_parameters=['ns3::snowPhyEnumeration'])
    ...
    ## snow-helper.h (module 'snow'): ns3::snowHelper [class]
    module.add_class('snowHelper', parent=[root_module['ns3::PcapHelperForDevice'], root_module['ns3::AsciiTraceHelperForDevice']])
    ## snow-lqi-tag.h (module 'snow'): ns3::snowLqiTag [class]
    module.add_class('snowLqiTag', parent=root_module['ns3::Tag'])
    ## snow-mac-header.h (module 'snow'): ns3::snowMacHeader [class]
    module.add_class('snowMacHeader', parent=root_module['ns3::Header'])
    ## snow-mac-header.h (module 'snow'): ns3::snowMacHeader::snowMacType [enumeration]
    module.add_enum('snowMacType', ['snow_MAC_BEACON', 'snow_MAC_DATA', 'snow_MAC_ACKNOWLEDGMENT', 'snow_MAC_COMMAND', 'snow_MAC_RESERVED'], outer_class=root_module['ns3::snowMacHeader'])
    ## snow-mac-header.h (module 'snow'): ns3::snowMacHeader::AddrModeType [enumeration]
    module.add_enum('AddrModeType', ['NOADDR', 'RESADDR', 'SHORTADDR', 'EXTADDR'], outer_class=root_module['ns3::snowMacHeader'])
    ## snow-mac-header.h (module 'snow'): ns3::snowMacHeader::KeyIdModeType [enumeration]
    module.add_enum('KeyIdModeType', ['IMPLICIT', 'NOKEYSOURCE', 'SHORTKEYSOURCE', 'LONGKEYSOURCE'], outer_class=root_module['ns3::snowMacHeader'])
    ...
    ## simple-ref-count.h (module 'core'): ns3::SimpleRefCount<ns3::snowInterferenceHelper, ns3::empty, ns3::DefaultDeleter<ns3::snowInterferenceHelper>> [class]
    module.add_class('SimpleRefCount', automatic_type_narrowing=True, memory_policy=cppclass.ReferenceCountingMethodsPolicy(incref_method='Ref', decref_method='Unref', peekref_method='GetReferenceCount'), parent=root_module['ns3::empty'], template_parameters=['ns3::snowInterferenceHelper', 'ns3::empty', 'ns3::DefaultDeleter<ns3::snowInterferenceHelper>'])
    ...
    ## snow-mac-pl-headers.h (module 'snow'): ns3::BeaconPayloadHeader [class]
    ...
    ## snow-mac-pl-headers.h (module 'snow'): ns3::CommandPayloadHeader [class]
    module.add_class('CommandPayloadHeader', parent=root_module['ns3::Header'])
    ## snow-mac-pl-headers.h (module 'snow'): ns3::CommandPayloadHeader::MacCommand [enumeration]
    ...
    ## snow-csmaca.h (module 'snow'): ns3::snowCsmaCa [class]
    module.add_class('snowCsmaCa', parent=root_module['ns3::Object'])
    ## snow-error-model.h (module 'snow'): ns3::snowErrorModel [class]
    module.add_class('snowErrorModel', parent=root_module['ns3::Object'])
    ## snow-interference-helper.h (module 'snow'): ns3::snowInterferenceHelper [class]
    module.add_class('snowInterferenceHelper', parent=root_module['ns3::SimpleRefCount< ns3::snowInterferenceHelper, ns3::empty, ns3::DefaultDeleter<ns3::snowInterferenceHelper> >'])
    ## snow-mac.h (module 'snow'): ns3::snowMac [class]
    module.add_class('snowMac', parent=root_module['ns3::Object'])
    typehandlers.add_type_alias('void ( * ) ( ns3::Ptr< ns3::Packet const >, uint8_t, uint8_t )', 'ns3::snowMac::SentTracedCallback')
    typehandlers.add_type_alias('void ( * ) ( ns3::Ptr< ns3::Packet const >, uint8_t, uint8_t )*', 'ns3::snowMac::SentTracedCallback*')
    typehandlers.add_type_alias('void ( * ) ( ns3::Ptr< ns3::Packet const >, uint8_t, uint8_t )&', 'ns3::snowMac::SentTracedCallback&')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowMacState, ns3::snowMacState )', 'ns3::snowMac::StateTracedCallback')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowMacState, ns3::snowMacState )*', 'ns3::snowMac::StateTracedCallback*')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowMacState, ns3::snowMacState )&', 'ns3::snowMac::StateTracedCallback&')
    ## snow-mac-trailer.h (module 'snow'): ns3::snowMacTrailer [class]
    module.add_class('snowMacTrailer', parent=root_module['ns3::Trailer'])
    ## snow-phy.h (module 'snow'): ns3::snowPhy [class]
    module.add_class('snowPhy', parent=root_module['ns3::SpectrumPhy'])
    typehandlers.add_type_alias('void ( * ) ( ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration )', 'ns3::snowPhy::StateTracedCallback')
    typehandlers.add_type_alias('void ( * ) ( ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration )*', 'ns3::snowPhy::StateTracedCallback*')
    typehandlers.add_type_alias('void ( * ) ( ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration )&', 'ns3::snowPhy::StateTracedCallback&')
    ## snow-spectrum-signal-parameters.h (module 'snow'): ns3::snowSpectrumSignalParameters [struct]
    module.add_class('snowSpectrumSignalParameters', parent=root_module['ns3::SpectrumSignalParameters'])
    ...
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> [class]
    module.add_class('CallbackImpl', import_from_module='ns.core', parent=root_module['ns3::CallbackImplBase'], template_parameters=['void', 'ns3::snowMacState', 'ns3::snowMacState', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> [class]
    module.add_class('CallbackImpl', import_from_module='ns.core', parent=root_module['ns3::CallbackImplBase'], template_parameters=['void', 'ns3::snowPhyEnumeration', 'ns3::snowPhyEnumeration', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'])
    ...
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> [class]
    module.add_class('CallbackImpl', import_from_module='ns.core', parent=root_module['ns3::CallbackImplBase'], template_parameters=['void', 'ns3::Time', 'ns3::snowPhyEnumeration', 'ns3::snowPhyEnumeration', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'])
    ...
    ## snow-net-device.h (module 'snow'): ns3::snowNetDevice [class]
    module.add_class('snowNetDevice', parent=root_module['ns3::NetDevice'])
    ## snow-net-device.h (module 'snow'): ns3::snowNetDevice::PseudoMacAddressMode_e [enumeration]
    module.add_enum('PseudoMacAddressMode_e', ['RFC4944', 'RFC6282'], outer_class=root_module['ns3::snowNetDevice'])
    ...
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ns3::snowMacStateCallback')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::snowMacStateCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::snowMacStateCallback&')
    typehandlers.add_type_alias('ns3::Callback< void, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ns3::snowMacTransCostCallback')
    typehandlers.add_type_alias('ns3::Callback< void, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::snowMacTransCostCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::snowMacTransCostCallback&')
    typehandlers.add_type_alias('ns3::snowTxOption', 'ns3::snowTxOption')
    typehandlers.add_type_alias('ns3::snowTxOption*', 'ns3::snowTxOption*')
    typehandlers.add_type_alias('ns3::snowTxOption&', 'ns3::snowTxOption&')
    typehandlers.add_type_alias('ns3::snowMacState', 'ns3::snowMacState')
    typehandlers.add_type_alias('ns3::snowMacState*', 'ns3::snowMacState*')
    typehandlers.add_type_alias('ns3::snowMacState&', 'ns3::snowMacState&')
    ...
    typehandlers.add_type_alias('ns3::SuperframeType*', 'ns3::SuperframeType*')
    typehandlers.add_type_alias('ns3::SuperframeType&', 'ns3::SuperframeType&')
    typehandlers.add_type_alias('ns3::snowAddressMode', 'ns3::snowAddressMode')
    typehandlers.add_type_alias('ns3::snowAddressMode*', 'ns3::snowAddressMode*')
    typehandlers.add_type_alias('ns3::snowAddressMode&', 'ns3::snowAddressMode&')
    typehandlers.add_type_alias('ns3::snowAssociationStatus', 'ns3::snowAssociationStatus')
    typehandlers.add_type_alias('ns3::snowAssociationStatus*', 'ns3::snowAssociationStatus*')
    typehandlers.add_type_alias('ns3::snowAssociationStatus&', 'ns3::snowAssociationStatus&')
    typehandlers.add_type_alias('ns3::snowMcpsDataConfirmStatus', 'ns3::snowMcpsDataConfirmStatus')
    typehandlers.add_type_alias('ns3::snowMcpsDataConfirmStatus*', 'ns3::snowMcpsDataConfirmStatus*')
    typehandlers.add_type_alias('ns3::snowMcpsDataConfirmStatus&', 'ns3::snowMcpsDataConfirmStatus&')
    typehandlers.add_type_alias('ns3::snowMlmeStartConfirmStatus', 'ns3::snowMlmeStartConfirmStatus')
    typehandlers.add_type_alias('ns3::snowMlmeStartConfirmStatus*', 'ns3::snowMlmeStartConfirmStatus*')
    typehandlers.add_type_alias('ns3::snowMlmeStartConfirmStatus&', 'ns3::snowMlmeStartConfirmStatus&')
    typehandlers.add_type_alias('ns3::snowSyncLossReason', 'ns3::snowSyncLossReason')
    typehandlers.add_type_alias('ns3::snowSyncLossReason*', 'ns3::snowSyncLossReason*')
    typehandlers.add_type_alias('ns3::snowSyncLossReason&', 'ns3::snowSyncLossReason&')
    typehandlers.add_type_alias('ns3::snowMlmePollConfirmStatus', 'ns3::snowMlmePollConfirmStatus')
    typehandlers.add_type_alias('ns3::snowMlmePollConfirmStatus*', 'ns3::snowMlmePollConfirmStatus*')
    typehandlers.add_type_alias('ns3::snowMlmePollConfirmStatus&', 'ns3::snowMlmePollConfirmStatus&')
    ...
    typehandlers.add_type_alias('ns3::SequenceNumber< unsigned char, signed char >*', 'ns3::SequenceNumber8*')
    typehandlers.add_type_alias('ns3::SequenceNumber< unsigned char, signed char >&', 'ns3::SequenceNumber8&')
    typehandlers.add_type_alias('ns3::snowEdPower', 'ns3::snowEdPower')
    typehandlers.add_type_alias('ns3::snowEdPower*', 'ns3::snowEdPower*')
    typehandlers.add_type_alias('ns3::snowEdPower&', 'ns3::snowEdPower&')
    module.add_typedef(root_module['ns3::snowEdPower'], 'snowEdPower')
    typehandlers.add_type_alias('ns3::snowPhyDataAndSymbolRates', 'ns3::snowPhyDataAndSymbolRates')
    typehandlers.add_type_alias('ns3::snowPhyDataAndSymbolRates*', 'ns3::snowPhyDataAndSymbolRates*')
    typehandlers.add_type_alias('ns3::snowPhyDataAndSymbolRates&', 'ns3::snowPhyDataAndSymbolRates&')
    module.add_typedef(root_module['ns3::snowPhyDataAndSymbolRates'], 'snowPhyDataAndSymbolRates')
    typehandlers.add_type_alias('ns3::snowPhyPpduHeaderSymbolNumber', 'ns3::snowPhyPpduHeaderSymbolNumber')
    typehandlers.add_type_alias('ns3::snowPhyPpduHeaderSymbolNumber*', 'ns3::snowPhyPpduHeaderSymbolNumber*')
    typehandlers.add_type_alias('ns3::snowPhyPpduHeaderSymbolNumber&', 'ns3::snowPhyPpduHeaderSymbolNumber&')
    module.add_typedef(root_module['ns3::snowPhyPpduHeaderSymbolNumber'], 'snowPhyPpduHeaderSymbolNumber')
    typehandlers.add_type_alias('ns3::snowPhyOption', 'ns3::snowPhyOption')
    typehandlers.add_type_alias('ns3::snowPhyOption*', 'ns3::snowPhyOption*')
    typehandlers.add_type_alias('ns3::snowPhyOption&', 'ns3::snowPhyOption&')
    typehandlers.add_type_alias('ns3::snowPhyEnumeration', 'ns3::snowPhyEnumeration')
    typehandlers.add_type_alias('ns3::snowPhyEnumeration*', 'ns3::snowPhyEnumeration*')
    typehandlers.add_type_alias('ns3::snowPhyEnumeration&', 'ns3::snowPhyEnumeration&')
    typehandlers.add_type_alias('ns3::snowPibAttributeIdentifier', 'ns3::snowPibAttributeIdentifier')
    typehandlers.add_type_alias('ns3::snowPibAttributeIdentifier*', 'ns3::snowPibAttributeIdentifier*')
    typehandlers.add_type_alias('ns3::snowPibAttributeIdentifier&', 'ns3::snowPibAttributeIdentifier&')
    typehandlers.add_type_alias('ns3::snowPhyPibAttributes', 'ns3::snowPhyPibAttributes')
    typehandlers.add_type_alias('ns3::snowPhyPibAttributes*', 'ns3::snowPhyPibAttributes*')
    typehandlers.add_type_alias('ns3::snowPhyPibAttributes&', 'ns3::snowPhyPibAttributes&')
    module.add_typedef(root_module['ns3::snowPhyPibAttributes'], 'snowPhyPibAttributes')
    ...
    typehandlers.add_type_alias('ns3::Callback< void, unsigned int, ns3::Ptr< ns3::Packet >, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::PdDataIndicationCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, unsigned int, ns3::Ptr< ns3::Packet >, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::PdDataIndicationCallback&')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ns3::PdDataConfirmCallback')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::PdDataConfirmCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::PdDataConfirmCallback&')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ns3::PlmeCcaConfirmCallback')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::PlmeCcaConfirmCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::PlmeCcaConfirmCallback&')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ns3::PlmeEdConfirmCallback')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::PlmeEdConfirmCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::PlmeEdConfirmCallback&')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::snowPibAttributeIdentifier, ns3::snowPhyPibAttributes *, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ns3::PlmeGetAttributeConfirmCallback')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::snowPibAttributeIdentifier, ns3::snowPhyPibAttributes *, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::PlmeGetAttributeConfirmCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::snowPibAttributeIdentifier, ns3::snowPhyPibAttributes *, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::PlmeGetAttributeConfirmCallback&')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ns3::PlmeSetTRXStateConfirmCallback')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::PlmeSetTRXStateConfirmCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::PlmeSetTRXStateConfirmCallback&')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::snowPibAttributeIdentifier, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ns3::PlmeSetAttributeConfirmCallback')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::snowPibAttributeIdentifier, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >*', 'ns3::PlmeSetAttributeConfirmCallback*')
    typehandlers.add_type_alias('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::snowPibAttributeIdentifier, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >&', 'ns3::PlmeSetAttributeConfirmCallback&')
...
def register_types_ns3_TracedValueCallback(module):
    ...
    typehandlers.add_type_alias('void ( * ) ( ns3::Time, ns3::Time )*', 'ns3::TracedValueCallback::Time*')
    typehandlers.add_type_alias('void ( * ) ( ns3::Time, ns3::Time )&', 'ns3::TracedValueCallback::Time&')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowMacState, ns3::snowMacState )', 'ns3::TracedValueCallback::snowMacState')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowMacState, ns3::snowMacState )*', 'ns3::TracedValueCallback::snowMacState*')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowMacState, ns3::snowMacState )&', 'ns3::TracedValueCallback::snowMacState&')
    ...
    typehandlers.add_type_alias('void ( * ) ( ns3::SequenceNumber32, ns3::SequenceNumber32 )*', 'ns3::TracedValueCallback::SequenceNumber32*')
    typehandlers.add_type_alias('void ( * ) ( ns3::SequenceNumber32, ns3::SequenceNumber32 )&', 'ns3::TracedValueCallback::SequenceNumber32&')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowPhyEnumeration, ns3::snowPhyEnumeration )', 'ns3::TracedValueCallback::snowPhyEnumeration')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowPhyEnumeration, ns3::snowPhyEnumeration )*', 'ns3::TracedValueCallback::snowPhyEnumeration*')
    typehandlers.add_type_alias('void ( * ) ( ns3::snowPhyEnumeration, ns3::snowPhyEnumeration )&', 'ns3::TracedValueCallback::snowPhyEnumeration&')
...
def register_methods(root_module):
    ...
    register_Ns3DefaultDeleter__Ns3snowInterferenceHelper_methods(root_module, root_module['ns3::DefaultDeleter< ns3::snowInterferenceHelper >'])
    ...
    register_Ns3snowEdPower_methods(root_module, root_module['ns3::snowEdPower'])
    register_Ns3snowPhyDataAndSymbolRates_methods(root_module, root_module['ns3::snowPhyDataAndSymbolRates'])
    register_Ns3snowPhyPibAttributes_methods(root_module, root_module['ns3::snowPhyPibAttributes'])
    register_Ns3snowPhyPpduHeaderSymbolNumber_methods(root_module, root_module['ns3::snowPhyPpduHeaderSymbolNumber'])
    register_Ns3snowSpectrumValueHelper_methods(root_module, root_module['ns3::snowSpectrumValueHelper'])
    ...
    register_Ns3TracedValue__Ns3snowMacState_methods(root_module, root_module['ns3::TracedValue< ns3::snowMacState >'])
    register_Ns3TracedValue__Ns3snowPhyEnumeration_methods(root_module, root_module['ns3::TracedValue< ns3::snowPhyEnumeration >'])
    ...
    register_Ns3snowHelper_methods(root_module, root_module['ns3::snowHelper'])
    register_Ns3snowLqiTag_methods(root_module, root_module['ns3::snowLqiTag'])
    register_Ns3snowMacHeader_methods(root_module, root_module['ns3::snowMacHeader'])
    ...
    register_Ns3SimpleRefCount__Ns3snowInterferenceHelper_Ns3Empty_Ns3DefaultDeleter__lt__ns3snowInterferenceHelper__gt___methods(root_module, root_module['ns3::SimpleRefCount< ns3::snowInterferenceHelper, ns3::empty, ns3::DefaultDeleter<ns3::snowInterferenceHelper> >'])
    ...
    register_Ns3snowCsmaCa_methods(root_module, root_module['ns3::snowCsmaCa'])
    register_Ns3snowErrorModel_methods(root_module, root_module['ns3::snowErrorModel'])
    register_Ns3snowInterferenceHelper_methods(root_module, root_module['ns3::snowInterferenceHelper'])
    register_Ns3snowMac_methods(root_module, root_module['ns3::snowMac'])
    register_Ns3snowMacTrailer_methods(root_module, root_module['ns3::snowMacTrailer'])
    register_Ns3snowPhy_methods(root_module, root_module['ns3::snowPhy'])
    register_Ns3snowSpectrumSignalParameters_methods(root_module, root_module['ns3::snowSpectrumSignalParameters'])
    ...
    register_Ns3CallbackImpl__Void_Ns3snowMacState_Ns3snowMacState_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, root_module['ns3::CallbackImpl< void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >'])
    register_Ns3CallbackImpl__Void_Ns3snowPhyEnumeration_Ns3snowPhyEnumeration_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, root_module['ns3::CallbackImpl< void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >'])
    ...
    register_Ns3CallbackImpl__Void_Ns3Time_Ns3snowPhyEnumeration_Ns3snowPhyEnumeration_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, root_module['ns3::CallbackImpl< void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >'])
    ...
    register_Ns3snowNetDevice_methods(root_module, root_module['ns3::snowNetDevice'])
...
def register_Ns3DefaultDeleter__Ns3snowInterferenceHelper_methods(root_module, cls):
    ## default-deleter.h (module 'core'): ns3::DefaultDeleter<ns3::snowInterferenceHelper>::DefaultDeleter() [constructor]
    cls.add_constructor([])
    ## default-deleter.h (module 'core'): ns3::DefaultDeleter<ns3::snowInterferenceHelper>::DefaultDeleter(ns3::DefaultDeleter<ns3::snowInterferenceHelper> const & arg0) [constructor]
    cls.add_constructor([param('ns3::DefaultDeleter< ns3::snowInterferenceHelper > const &', 'arg0')])
    ## default-deleter.h (module 'core'): static void ns3::DefaultDeleter<ns3::snowInterferenceHelper>::Delete(ns3::snowInterferenceHelper * object) [member function]
    cls.add_method('Delete', 
                   'void', 
                   [param('ns3::snowInterferenceHelper *', 'object')],
                   is_static=True)
    return
...
def register_Ns3GtsFields_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## snow-fields.h (module 'snow'): ns3::GtsFields::GtsFields(ns3::GtsFields const & arg0) [constructor]
    cls.add_constructor([param('ns3::GtsFields const &', 'arg0')])
    ## snow-fields.h (module 'snow'): ns3::GtsFields::GtsFields() [constructor]
    cls.add_constructor([])
    ## snow-fields.h (module 'snow'): ns3::Buffer::Iterator ns3::GtsFields::Deserialize(ns3::Buffer::Iterator i) [member function]
    cls.add_method('Deserialize', 
                   'ns3::Buffer::Iterator', 
                   [param('ns3::Buffer::Iterator', 'i')])
    ## snow-fields.h (module 'snow'): uint8_t ns3::GtsFields::GetGtsDirectionField() const [member function]
    cls.add_method('GetGtsDirectionField', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint8_t ns3::GtsFields::GetGtsSpecField() const [member function]
    cls.add_method('GetGtsSpecField', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint32_t ns3::GtsFields::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): ns3::Buffer::Iterator ns3::GtsFields::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'ns3::Buffer::Iterator', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): void ns3::GtsFields::SetGtsDirectionField(uint8_t gtsDir) [member function]
    cls.add_method('SetGtsDirectionField', 
                   'void', 
                   [param('uint8_t', 'gtsDir')])
    ## snow-fields.h (module 'snow'): void ns3::GtsFields::SetGtsSpecField(uint8_t gtsSpec) [member function]
...
def register_Ns3snowEdPower_methods(root_module, cls):
    ## snow-phy.h (module 'snow'): ns3::snowEdPower() [constructor]
    cls.add_constructor([])
    ## snow-phy.h (module 'snow'): ns3::snowEdPower(ns3::snowEdPower const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowEdPower const &', 'arg0')])
    ## snow-phy.h (module 'snow'): ns3::snowEdPower::averagePower [variable]
    cls.add_instance_attribute('averagePower', 'double', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowEdPower::lastUpdate [variable]
    cls.add_instance_attribute('lastUpdate', 'ns3::Time', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowEdPower::measurementLength [variable]
    cls.add_instance_attribute('measurementLength', 'ns3::Time', is_const=False)
    return

def register_Ns3snowPhyDataAndSymbolRates_methods(root_module, cls):
    ## snow-phy.h (module 'snow'): ns3::snowPhyDataAndSymbolRates() [constructor]
    cls.add_constructor([])
    ## snow-phy.h (module 'snow'): ns3::snowPhyDataAndSymbolRates(ns3::snowPhyDataAndSymbolRates const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowPhyDataAndSymbolRates const &', 'arg0')])
    ## snow-phy.h (module 'snow'): ns3::snowPhyDataAndSymbolRates::bitRate [variable]
    cls.add_instance_attribute('bitRate', 'double', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyDataAndSymbolRates::symbolRate [variable]
    cls.add_instance_attribute('symbolRate', 'double', is_const=False)
    return

def register_Ns3snowPhyPibAttributes_methods(root_module, cls):
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes() [constructor]
    cls.add_constructor([])
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes(ns3::snowPhyPibAttributes const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowPhyPibAttributes const &', 'arg0')])
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes::phyCCAMode [variable]
    cls.add_instance_attribute('phyCCAMode', 'uint8_t', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes::phyChannelsSupported [variable]
    cls.add_instance_attribute('phyChannelsSupported', 'uint32_t [ 32 ]', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes::phyCurrentChannel [variable]
    cls.add_instance_attribute('phyCurrentChannel', 'uint8_t', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes::phyCurrentPage [variable]
    cls.add_instance_attribute('phyCurrentPage', 'uint32_t', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes::phyMaxFrameDuration [variable]
    cls.add_instance_attribute('phyMaxFrameDuration', 'uint32_t', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes::phySHRDuration [variable]
    cls.add_instance_attribute('phySHRDuration', 'uint32_t', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes::phySymbolsPerOctet [variable]
    cls.add_instance_attribute('phySymbolsPerOctet', 'double', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPibAttributes::phyTransmitPower [variable]
    cls.add_instance_attribute('phyTransmitPower', 'uint8_t', is_const=False)
    return

def register_Ns3snowPhyPpduHeaderSymbolNumber_methods(root_module, cls):
    ## snow-phy.h (module 'snow'): ns3::snowPhyPpduHeaderSymbolNumber() [constructor]
    cls.add_constructor([])
    ## snow-phy.h (module 'snow'): ns3::snowPhyPpduHeaderSymbolNumber(ns3::snowPhyPpduHeaderSymbolNumber const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowPhyPpduHeaderSymbolNumber const &', 'arg0')])
    ## snow-phy.h (module 'snow'): ns3::snowPhyPpduHeaderSymbolNumber::phr [variable]
    cls.add_instance_attribute('phr', 'double', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPpduHeaderSymbolNumber::shrPreamble [variable]
    cls.add_instance_attribute('shrPreamble', 'double', is_const=False)
    ## snow-phy.h (module 'snow'): ns3::snowPhyPpduHeaderSymbolNumber::shrSfd [variable]
    cls.add_instance_attribute('shrSfd', 'double', is_const=False)
    return

def register_Ns3snowSpectrumValueHelper_methods(root_module, cls):
    ## snow-spectrum-value-helper.h (module 'snow'): ns3::snowSpectrumValueHelper::snowSpectrumValueHelper(ns3::snowSpectrumValueHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowSpectrumValueHelper const &', 'arg0')])
    ## snow-spectrum-value-helper.h (module 'snow'): ns3::snowSpectrumValueHelper::snowSpectrumValueHelper() [constructor]
    cls.add_constructor([])
    ## snow-spectrum-value-helper.h (module 'snow'): ns3::Ptr<ns3::SpectrumValue> ns3::snowSpectrumValueHelper::CreateNoisePowerSpectralDensity(uint32_t channel) [member function]
    cls.add_method('CreateNoisePowerSpectralDensity', 
                   'ns3::Ptr< ns3::SpectrumValue >', 
                   [param('uint32_t', 'channel')])
    ## snow-spectrum-value-helper.h (module 'snow'): ns3::Ptr<ns3::SpectrumValue> ns3::snowSpectrumValueHelper::CreateTxPowerSpectralDensity(double txPower, uint32_t channel) [member function]
    cls.add_method('CreateTxPowerSpectralDensity', 
                   'ns3::Ptr< ns3::SpectrumValue >', 
                   [param('double', 'txPower'), param('uint32_t', 'channel')])
    ## snow-spectrum-value-helper.h (module 'snow'): static double ns3::snowSpectrumValueHelper::TotalAvgPower(ns3::Ptr<const ns3::SpectrumValue> psd, uint32_t channel) [member function]
...
def register_Ns3McpsDataConfirmParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::McpsDataConfirmParams::McpsDataConfirmParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::McpsDataConfirmParams::McpsDataConfirmParams(ns3::McpsDataConfirmParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::McpsDataConfirmParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::McpsDataConfirmParams::m_msduHandle [variable]
    cls.add_instance_attribute('m_msduHandle', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataConfirmParams::m_status [variable]
    cls.add_instance_attribute('m_status', 'ns3::snowMcpsDataConfirmStatus', is_const=False)
    return

def register_Ns3McpsDataIndicationParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::McpsDataIndicationParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::McpsDataIndicationParams(ns3::McpsDataIndicationParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::McpsDataIndicationParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_dsn [variable]
    cls.add_instance_attribute('m_dsn', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_dstAddr [variable]
    cls.add_instance_attribute('m_dstAddr', 'ns3::Mac16Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_dstAddrMode [variable]
    cls.add_instance_attribute('m_dstAddrMode', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_dstExtAddr [variable]
    cls.add_instance_attribute('m_dstExtAddr', 'ns3::Mac64Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_dstPanId [variable]
    cls.add_instance_attribute('m_dstPanId', 'uint16_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_mpduLinkQuality [variable]
    cls.add_instance_attribute('m_mpduLinkQuality', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_srcAddr [variable]
    cls.add_instance_attribute('m_srcAddr', 'ns3::Mac16Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_srcAddrMode [variable]
    cls.add_instance_attribute('m_srcAddrMode', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_srcExtAddr [variable]
    cls.add_instance_attribute('m_srcExtAddr', 'ns3::Mac64Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataIndicationParams::m_srcPanId [variable]
...
def register_Ns3McpsDataRequestParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::McpsDataRequestParams(ns3::McpsDataRequestParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::McpsDataRequestParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::McpsDataRequestParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::m_dstAddr [variable]
    cls.add_instance_attribute('m_dstAddr', 'ns3::Mac16Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::m_dstAddrMode [variable]
    cls.add_instance_attribute('m_dstAddrMode', 'ns3::snowAddressMode', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::m_dstExtAddr [variable]
    cls.add_instance_attribute('m_dstExtAddr', 'ns3::Mac64Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::m_dstPanId [variable]
    cls.add_instance_attribute('m_dstPanId', 'uint16_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::m_msduHandle [variable]
    cls.add_instance_attribute('m_msduHandle', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::m_srcAddrMode [variable]
    cls.add_instance_attribute('m_srcAddrMode', 'ns3::snowAddressMode', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::McpsDataRequestParams::m_txOptions [variable]
...
def register_Ns3MlmeBeaconNotifyIndicationParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::MlmeBeaconNotifyIndicationParams::MlmeBeaconNotifyIndicationParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::MlmeBeaconNotifyIndicationParams::MlmeBeaconNotifyIndicationParams(ns3::MlmeBeaconNotifyIndicationParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::MlmeBeaconNotifyIndicationParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::MlmeBeaconNotifyIndicationParams::m_bsn [variable]
    cls.add_instance_attribute('m_bsn', 'uint8_t', is_const=False)
    return

def register_Ns3MlmePollConfirmParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::MlmePollConfirmParams::MlmePollConfirmParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::MlmePollConfirmParams::MlmePollConfirmParams(ns3::MlmePollConfirmParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::MlmePollConfirmParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::MlmePollConfirmParams::m_status [variable]
    cls.add_instance_attribute('m_status', 'ns3::snowMlmePollConfirmStatus', is_const=False)
    return

def register_Ns3MlmePollRequestParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::MlmePollRequestParams::MlmePollRequestParams(ns3::MlmePollRequestParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::MlmePollRequestParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::MlmePollRequestParams::MlmePollRequestParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::MlmePollRequestParams::m_coorAddrMode [variable]
    cls.add_instance_attribute('m_coorAddrMode', 'ns3::snowAddressMode', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmePollRequestParams::m_coorExtAddr [variable]
    cls.add_instance_attribute('m_coorExtAddr', 'ns3::Mac64Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmePollRequestParams::m_coorPanId [variable]
    cls.add_instance_attribute('m_coorPanId', 'uint16_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmePollRequestParams::m_coorShortAddr [variable]
...
def register_Ns3MlmeStartConfirmParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::MlmeStartConfirmParams::MlmeStartConfirmParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::MlmeStartConfirmParams::MlmeStartConfirmParams(ns3::MlmeStartConfirmParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::MlmeStartConfirmParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::MlmeStartConfirmParams::m_status [variable]
    cls.add_instance_attribute('m_status', 'ns3::snowMlmeStartConfirmStatus', is_const=False)
    return

def register_Ns3MlmeStartRequestParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::MlmeStartRequestParams(ns3::MlmeStartRequestParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::MlmeStartRequestParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::MlmeStartRequestParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_PanId [variable]
    cls.add_instance_attribute('m_PanId', 'uint16_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_battLifeExt [variable]
    cls.add_instance_attribute('m_battLifeExt', 'bool', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_bcnOrd [variable]
    cls.add_instance_attribute('m_bcnOrd', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_coorRealgn [variable]
    cls.add_instance_attribute('m_coorRealgn', 'bool', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_logCh [variable]
    cls.add_instance_attribute('m_logCh', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_logChPage [variable]
    cls.add_instance_attribute('m_logChPage', 'uint32_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_panCoor [variable]
    cls.add_instance_attribute('m_panCoor', 'bool', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_sfrmOrd [variable]
    cls.add_instance_attribute('m_sfrmOrd', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeStartRequestParams::m_startTime [variable]
...
def register_Ns3MlmeSyncLossIndicationParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncLossIndicationParams::MlmeSyncLossIndicationParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncLossIndicationParams::MlmeSyncLossIndicationParams(ns3::MlmeSyncLossIndicationParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::MlmeSyncLossIndicationParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncLossIndicationParams::m_logCh [variable]
    cls.add_instance_attribute('m_logCh', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncLossIndicationParams::m_lossReason [variable]
    cls.add_instance_attribute('m_lossReason', 'ns3::snowSyncLossReason', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncLossIndicationParams::m_panId [variable]
    cls.add_instance_attribute('m_panId', 'uint16_t', is_const=False)
    return

def register_Ns3MlmeSyncRequestParams_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncRequestParams::MlmeSyncRequestParams(ns3::MlmeSyncRequestParams const & arg0) [constructor]
    cls.add_constructor([param('ns3::MlmeSyncRequestParams const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncRequestParams::MlmeSyncRequestParams() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncRequestParams::m_logCh [variable]
    cls.add_instance_attribute('m_logCh', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::MlmeSyncRequestParams::m_trackBcn [variable]
...
def register_Ns3PendingAddrFields_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## snow-fields.h (module 'snow'): ns3::PendingAddrFields::PendingAddrFields(ns3::PendingAddrFields const & arg0) [constructor]
    cls.add_constructor([param('ns3::PendingAddrFields const &', 'arg0')])
    ## snow-fields.h (module 'snow'): ns3::PendingAddrFields::PendingAddrFields() [constructor]
    cls.add_constructor([])
    ## snow-fields.h (module 'snow'): void ns3::PendingAddrFields::AddAddress(ns3::Mac16Address shortAddr) [member function]
    cls.add_method('AddAddress', 
                   'void', 
                   [param('ns3::Mac16Address', 'shortAddr')])
    ## snow-fields.h (module 'snow'): void ns3::PendingAddrFields::AddAddress(ns3::Mac64Address extAddr) [member function]
    cls.add_method('AddAddress', 
                   'void', 
                   [param('ns3::Mac64Address', 'extAddr')])
    ## snow-fields.h (module 'snow'): ns3::Buffer::Iterator ns3::PendingAddrFields::Deserialize(ns3::Buffer::Iterator i) [member function]
    cls.add_method('Deserialize', 
                   'ns3::Buffer::Iterator', 
                   [param('ns3::Buffer::Iterator', 'i')])
    ## snow-fields.h (module 'snow'): uint8_t ns3::PendingAddrFields::GetNumExtAddr() const [member function]
    cls.add_method('GetNumExtAddr', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint8_t ns3::PendingAddrFields::GetNumShortAddr() const [member function]
    cls.add_method('GetNumShortAddr', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint8_t ns3::PendingAddrFields::GetPndAddrSpecField() const [member function]
    cls.add_method('GetPndAddrSpecField', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint32_t ns3::PendingAddrFields::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): bool ns3::PendingAddrFields::SearchAddress(ns3::Mac16Address shortAddr) [member function]
    cls.add_method('SearchAddress', 
                   'bool', 
                   [param('ns3::Mac16Address', 'shortAddr')])
    ## snow-fields.h (module 'snow'): bool ns3::PendingAddrFields::SearchAddress(ns3::Mac64Address extAddr) [member function]
    cls.add_method('SearchAddress', 
                   'bool', 
                   [param('ns3::Mac64Address', 'extAddr')])
    ## snow-fields.h (module 'snow'): ns3::Buffer::Iterator ns3::PendingAddrFields::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'ns3::Buffer::Iterator', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): void ns3::PendingAddrFields::SetPndAddrSpecField(uint8_t pndAddrSpecField) [member function]
...
def register_Ns3SuperframeField_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## snow-fields.h (module 'snow'): ns3::SuperframeField::SuperframeField(ns3::SuperframeField const & arg0) [constructor]
    cls.add_constructor([param('ns3::SuperframeField const &', 'arg0')])
    ## snow-fields.h (module 'snow'): ns3::SuperframeField::SuperframeField() [constructor]
    cls.add_constructor([])
    ## snow-fields.h (module 'snow'): ns3::Buffer::Iterator ns3::SuperframeField::Deserialize(ns3::Buffer::Iterator i) [member function]
    cls.add_method('Deserialize', 
                   'ns3::Buffer::Iterator', 
                   [param('ns3::Buffer::Iterator', 'i')])
    ## snow-fields.h (module 'snow'): uint8_t ns3::SuperframeField::GetBeaconOrder() const [member function]
    cls.add_method('GetBeaconOrder', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint8_t ns3::SuperframeField::GetFinalCapSlot() const [member function]
    cls.add_method('GetFinalCapSlot', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint8_t ns3::SuperframeField::GetFrameOrder() const [member function]
    cls.add_method('GetFrameOrder', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint32_t ns3::SuperframeField::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): uint16_t ns3::SuperframeField::GetSuperframe() const [member function]
    cls.add_method('GetSuperframe', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): bool ns3::SuperframeField::IsAssocPermit() const [member function]
    cls.add_method('IsAssocPermit', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): bool ns3::SuperframeField::IsBattLifeExt() const [member function]
    cls.add_method('IsBattLifeExt', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): bool ns3::SuperframeField::IsPanCoor() const [member function]
    cls.add_method('IsPanCoor', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): ns3::Buffer::Iterator ns3::SuperframeField::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'ns3::Buffer::Iterator', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True)
    ## snow-fields.h (module 'snow'): void ns3::SuperframeField::SetAssocPermit(bool assocPermit) [member function]
    cls.add_method('SetAssocPermit', 
                   'void', 
                   [param('bool', 'assocPermit')])
    ## snow-fields.h (module 'snow'): void ns3::SuperframeField::SetBattLifeExt(bool battLifeExt) [member function]
    cls.add_method('SetBattLifeExt', 
                   'void', 
                   [param('bool', 'battLifeExt')])
    ## snow-fields.h (module 'snow'): void ns3::SuperframeField::SetBeaconOrder(uint8_t bcnOrder) [member function]
    cls.add_method('SetBeaconOrder', 
                   'void', 
                   [param('uint8_t', 'bcnOrder')])
    ## snow-fields.h (module 'snow'): void ns3::SuperframeField::SetFinalCapSlot(uint8_t capSlot) [member function]
    cls.add_method('SetFinalCapSlot', 
                   'void', 
                   [param('uint8_t', 'capSlot')])
    ## snow-fields.h (module 'snow'): void ns3::SuperframeField::SetPanCoor(bool panCoor) [member function]
    cls.add_method('SetPanCoor', 
                   'void', 
                   [param('bool', 'panCoor')])
    ## snow-fields.h (module 'snow'): void ns3::SuperframeField::SetSuperframe(uint16_t superFrm) [member function]
    cls.add_method('SetSuperframe', 
                   'void', 
                   [param('uint16_t', 'superFrm')])
    ## snow-fields.h (module 'snow'): void ns3::SuperframeField::SetSuperframeOrder(uint8_t frmOrder) [member function]
...
def register_Ns3TracedValue__Ns3snowMacState_methods(root_module, cls):
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowMacState>::TracedValue() [constructor]
    cls.add_constructor([])
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowMacState>::TracedValue(ns3::TracedValue<ns3::snowMacState> const & o) [constructor]
    cls.add_constructor([param('ns3::TracedValue< ns3::snowMacState > const &', 'o')])
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowMacState>::TracedValue(ns3::snowMacState const & v) [constructor]
    cls.add_constructor([param('ns3::snowMacState const &', 'v')])
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowMacState>::TracedValue(ns3::TracedValue<ns3::snowMacState> const & other) [constructor]
    cls.add_constructor([param('ns3::TracedValue< ns3::snowMacState > const &', 'other')])
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowMacState>::TracedValue(ns3::TracedValue<ns3::snowMacState> const & other) [constructor]
    cls.add_constructor([param('ns3::TracedValue< ns3::snowMacState > const &', 'other')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowMacState>::Connect(ns3::CallbackBase const & cb, std::string path) [member function]
    cls.add_method('Connect', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb'), param('std::string', 'path')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowMacState>::ConnectWithoutContext(ns3::CallbackBase const & cb) [member function]
    cls.add_method('ConnectWithoutContext', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowMacState>::Disconnect(ns3::CallbackBase const & cb, std::string path) [member function]
    cls.add_method('Disconnect', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb'), param('std::string', 'path')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowMacState>::DisconnectWithoutContext(ns3::CallbackBase const & cb) [member function]
    cls.add_method('DisconnectWithoutContext', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb')])
    ## traced-value.h (module 'core'): ns3::snowMacState ns3::TracedValue<ns3::snowMacState>::Get() const [member function]
    cls.add_method('Get', 
                   'ns3::snowMacState',
                   [], 
                   is_const=True)
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowMacState>::Set(ns3::snowMacState const & v) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('ns3::snowMacState const &', 'v')])
    return

def register_Ns3TracedValue__Ns3snowPhyEnumeration_methods(root_module, cls):
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowPhyEnumeration>::TracedValue() [constructor]
    cls.add_constructor([])
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowPhyEnumeration>::TracedValue(ns3::TracedValue<ns3::snowPhyEnumeration> const & o) [constructor]
    cls.add_constructor([param('ns3::TracedValue< ns3::snowPhyEnumeration > const &', 'o')])
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::snowPhyEnumeration>::TracedValue(ns3::snowPhyEnumeration const & v) [constructor]
    cls.add_constructor([param('ns3::snowPhyEnumeration const &', 'v')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowPhyEnumeration>::Connect(ns3::CallbackBase const & cb, std::string path) [member function]
    cls.add_method('Connect', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb'), param('std::string', 'path')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowPhyEnumeration>::ConnectWithoutContext(ns3::CallbackBase const & cb) [member function]
    cls.add_method('ConnectWithoutContext', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowPhyEnumeration>::Disconnect(ns3::CallbackBase const & cb, std::string path) [member function]
    cls.add_method('Disconnect', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb'), param('std::string', 'path')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowPhyEnumeration>::DisconnectWithoutContext(ns3::CallbackBase const & cb) [member function]
    cls.add_method('DisconnectWithoutContext', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb')])
    ## traced-value.h (module 'core'): ns3::snowPhyEnumeration ns3::TracedValue<ns3::snowPhyEnumeration>::Get() const [member function]
    cls.add_method('Get', 
                   'ns3::snowPhyEnumeration',
                   [], 
                   is_const=True)
    ## traced-value.h (module 'core'): void ns3::TracedValue<ns3::snowPhyEnumeration>::Set(ns3::snowPhyEnumeration const & v) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('ns3::snowPhyEnumeration const &', 'v')])
    return
...
def register_Ns3snowHelper_methods(root_module, cls):
    ## snow-helper.h (module 'snow'): ns3::snowHelper::snowHelper() [constructor]
    cls.add_constructor([])
    ## snow-helper.h (module 'snow'): ns3::snowHelper::snowHelper(bool useMultiModelSpectrumChannel) [constructor]
    cls.add_constructor([param('bool', 'useMultiModelSpectrumChannel')])
    ## snow-helper.h (module 'snow'): ns3::Ptr<ns3::SpectrumChannel> ns3::snowHelper::GetChannel() [member function]
    cls.add_method('GetChannel', 
                   'ns3::Ptr< ns3::SpectrumChannel >', 
                   [])
    ## snow-helper.h (module 'snow'): void ns3::snowHelper::SetChannel(ns3::Ptr<ns3::SpectrumChannel> channel) [member function]
    cls.add_method('SetChannel', 
                   'void', 
                   [param('ns3::Ptr< ns3::SpectrumChannel >', 'channel')])
    ## snow-helper.h (module 'snow'): void ns3::snowHelper::SetChannel(std::string channelName) [member function]
    cls.add_method('SetChannel', 
                   'void', 
                   [param('std::string', 'channelName')])
    ## snow-helper.h (module 'snow'): void ns3::snowHelper::AddMobility(ns3::Ptr<ns3::snowPhy> phy, ns3::Ptr<ns3::MobilityModel> m) [member function]
    cls.add_method('AddMobility', 
                   'void', 
                   [param('ns3::Ptr< ns3::snowPhy >', 'phy'), param('ns3::Ptr< ns3::MobilityModel >', 'm')])
    ## snow-helper.h (module 'snow'): ns3::NetDeviceContainer ns3::snowHelper::Install(ns3::NodeContainer c) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::NodeContainer', 'c')])
    ## snow-helper.h (module 'snow'): void ns3::snowHelper::AssociateToPan(ns3::NetDeviceContainer c, uint16_t panId) [member function]
    cls.add_method('AssociateToPan', 
                   'void', 
                   [param('ns3::NetDeviceContainer', 'c'), param('uint16_t', 'panId')])
    ## snow-helper.h (module 'snow'): void ns3::snowHelper::AssociateToBeaconPan(ns3::NetDeviceContainer c, uint16_t panId, ns3::Mac16Address coor, uint8_t bcnOrd, uint8_t sfrmOrd) [member function]
    ...
    ## snow-helper.h (module 'snow'): void ns3::snowHelper::EnableLogComponents() [member function]
    cls.add_method('EnableLogComponents', 
                   'void', 
                   [])
    ## snow-helper.h (module 'snow'): static std::string ns3::snowHelper::snowPhyEnumerationPrinter(ns3::snowPhyEnumeration e) [member function]
    cls.add_method('snowPhyEnumerationPrinter',
                   'std::string', 
                   [param('ns3::snowPhyEnumeration', 'e')],
                   is_static=True)
    ## snow-helper.h (module 'snow'): static std::string ns3::snowHelper::snowMacStatePrinter(ns3::snowMacState e) [member function]
    cls.add_method('snowMacStatePrinter',
                   'std::string', 
                   [param('ns3::snowMacState', 'e')],
                   is_static=True)
    ## snow-helper.h (module 'snow'): int64_t ns3::snowHelper::AssignStreams(ns3::NetDeviceContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NetDeviceContainer', 'c'), param('int64_t', 'stream')])
    ## snow-helper.h (module 'snow'): void ns3::snowHelper::EnablePcapInternal(std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool promiscuous, bool explicitFilename) [member function]
    cls.add_method('EnablePcapInternal', 
                   'void', 
                   [param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'promiscuous'), param('bool', 'explicitFilename')], 
                   is_virtual=True, visibility='private')
    ## snow-helper.h (module 'snow'): void ns3::snowHelper::EnableAsciiInternal(ns3::Ptr<ns3::OutputStreamWrapper> stream, std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool explicitFilename) [member function]
    cls.add_method('EnableAsciiInternal', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'explicitFilename')], 
                   is_virtual=True, visibility='private')
...
def register_Ns3snowLqiTag_methods(root_module, cls):
    ## snow-lqi-tag.h (module 'snow'): ns3::snowLqiTag::snowLqiTag(ns3::snowLqiTag const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowLqiTag const &', 'arg0')])
    ## snow-lqi-tag.h (module 'snow'): ns3::snowLqiTag::snowLqiTag() [constructor]
    cls.add_constructor([])
    ## snow-lqi-tag.h (module 'snow'): ns3::snowLqiTag::snowLqiTag(uint8_t lqi) [constructor]
    cls.add_constructor([param('uint8_t', 'lqi')])
    ## snow-lqi-tag.h (module 'snow'): void ns3::snowLqiTag::Deserialize(ns3::TagBuffer i) [member function]
    cls.add_method('Deserialize', 
                   'void', 
                   [param('ns3::TagBuffer', 'i')], 
                   is_virtual=True)
    ## snow-lqi-tag.h (module 'snow'): uint8_t ns3::snowLqiTag::Get() const [member function]
    cls.add_method('Get', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-lqi-tag.h (module 'snow'): ns3::TypeId ns3::snowLqiTag::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-lqi-tag.h (module 'snow'): uint32_t ns3::snowLqiTag::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-lqi-tag.h (module 'snow'): static ns3::TypeId ns3::snowLqiTag::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-lqi-tag.h (module 'snow'): void ns3::snowLqiTag::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## snow-lqi-tag.h (module 'snow'): void ns3::snowLqiTag::Serialize(ns3::TagBuffer i) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::TagBuffer', 'i')], 
                   is_const=True, is_virtual=True)
    ## snow-lqi-tag.h (module 'snow'): void ns3::snowLqiTag::Set(uint8_t lqi) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('uint8_t', 'lqi')])
    return

def register_Ns3snowMacHeader_methods(root_module, cls):
    ## snow-mac-header.h (module 'snow'): ns3::snowMacHeader::snowMacHeader(ns3::snowMacHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowMacHeader const &', 'arg0')])
    ## snow-mac-header.h (module 'snow'): ns3::snowMacHeader::snowMacHeader() [constructor]
    cls.add_constructor([])
    ## snow-mac-header.h (module 'snow'): ns3::snowMacHeader::snowMacHeader(ns3::snowMacHeader::snowMacType wpanMacType, uint8_t seqNum) [constructor]
    cls.add_constructor([param('ns3::snowMacHeader::snowMacType', 'wpanMacType'), param('uint8_t', 'seqNum')])
    ## snow-mac-header.h (module 'snow'): uint32_t ns3::snowMacHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetDstAddrMode() const [member function]
    cls.add_method('GetDstAddrMode', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint16_t ns3::snowMacHeader::GetDstPanId() const [member function]
    cls.add_method('GetDstPanId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): ns3::Mac64Address ns3::snowMacHeader::GetExtDstAddr() const [member function]
    cls.add_method('GetExtDstAddr', 
                   'ns3::Mac64Address', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): ns3::Mac64Address ns3::snowMacHeader::GetExtSrcAddr() const [member function]
    cls.add_method('GetExtSrcAddr', 
                   'ns3::Mac64Address', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint16_t ns3::snowMacHeader::GetFrameControl() const [member function]
    cls.add_method('GetFrameControl', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetFrameVer() const [member function]
    cls.add_method('GetFrameVer', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint32_t ns3::snowMacHeader::GetFrmCounter() const [member function]
    cls.add_method('GetFrmCounter', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetFrmCtrlRes() const [member function]
    cls.add_method('GetFrmCtrlRes', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): ns3::TypeId ns3::snowMacHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetKeyIdIndex() const [member function]
    cls.add_method('GetKeyIdIndex', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetKeyIdMode() const [member function]
    cls.add_method('GetKeyIdMode', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint32_t ns3::snowMacHeader::GetKeyIdSrc32() const [member function]
    cls.add_method('GetKeyIdSrc32', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint64_t ns3::snowMacHeader::GetKeyIdSrc64() const [member function]
    cls.add_method('GetKeyIdSrc64', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetSecControl() const [member function]
    cls.add_method('GetSecControl', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetSecCtrlReserved() const [member function]
    cls.add_method('GetSecCtrlReserved', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetSecLevel() const [member function]
    cls.add_method('GetSecLevel', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetSeqNum() const [member function]
    cls.add_method('GetSeqNum', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint32_t ns3::snowMacHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-mac-header.h (module 'snow'): ns3::Mac16Address ns3::snowMacHeader::GetShortDstAddr() const [member function]
    cls.add_method('GetShortDstAddr', 
                   'ns3::Mac16Address', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): ns3::Mac16Address ns3::snowMacHeader::GetShortSrcAddr() const [member function]
    cls.add_method('GetShortSrcAddr', 
                   'ns3::Mac16Address', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint8_t ns3::snowMacHeader::GetSrcAddrMode() const [member function]
    cls.add_method('GetSrcAddrMode', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): uint16_t ns3::snowMacHeader::GetSrcPanId() const [member function]
    cls.add_method('GetSrcPanId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): ns3::snowMacHeader::snowMacType ns3::snowMacHeader::GetType() const [member function]
    cls.add_method('GetType', 
                   'ns3::snowMacHeader::snowMacType',
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): static ns3::TypeId ns3::snowMacHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-mac-header.h (module 'snow'): bool ns3::snowMacHeader::IsAckReq() const [member function]
    cls.add_method('IsAckReq', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): bool ns3::snowMacHeader::IsAcknowledgment() const [member function]
    cls.add_method('IsAcknowledgment', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): bool ns3::snowMacHeader::IsBeacon() const [member function]
    cls.add_method('IsBeacon', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): bool ns3::snowMacHeader::IsCommand() const [member function]
    cls.add_method('IsCommand', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): bool ns3::snowMacHeader::IsData() const [member function]
    cls.add_method('IsData', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): bool ns3::snowMacHeader::IsFrmPend() const [member function]
    cls.add_method('IsFrmPend', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): bool ns3::snowMacHeader::IsPanIdComp() const [member function]
    cls.add_method('IsPanIdComp', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): bool ns3::snowMacHeader::IsSecEnable() const [member function]
    cls.add_method('IsSecEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetAckReq() [member function]
    cls.add_method('SetAckReq', 
                   'void', 
                   [])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetDstAddrFields(uint16_t panId, ns3::Mac16Address addr) [member function]
    cls.add_method('SetDstAddrFields', 
                   'void', 
                   [param('uint16_t', 'panId'), param('ns3::Mac16Address', 'addr')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetDstAddrFields(uint16_t panId, ns3::Mac64Address addr) [member function]
    cls.add_method('SetDstAddrFields', 
                   'void', 
                   [param('uint16_t', 'panId'), param('ns3::Mac64Address', 'addr')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetDstAddrMode(uint8_t addrMode) [member function]
    cls.add_method('SetDstAddrMode', 
                   'void', 
                   [param('uint8_t', 'addrMode')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetFrameControl(uint16_t frameControl) [member function]
    cls.add_method('SetFrameControl', 
                   'void', 
                   [param('uint16_t', 'frameControl')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetFrameVer(uint8_t ver) [member function]
    cls.add_method('SetFrameVer', 
                   'void', 
                   [param('uint8_t', 'ver')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetFrmCounter(uint32_t frmCntr) [member function]
    cls.add_method('SetFrmCounter', 
                   'void', 
                   [param('uint32_t', 'frmCntr')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetFrmCtrlRes(uint8_t res) [member function]
    cls.add_method('SetFrmCtrlRes', 
                   'void', 
                   [param('uint8_t', 'res')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetFrmPend() [member function]
    cls.add_method('SetFrmPend', 
                   'void', 
                   [])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetKeyId(uint8_t keyIndex) [member function]
    cls.add_method('SetKeyId', 
                   'void', 
                   [param('uint8_t', 'keyIndex')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetKeyId(uint32_t keySrc, uint8_t keyIndex) [member function]
    cls.add_method('SetKeyId', 
                   'void', 
                   [param('uint32_t', 'keySrc'), param('uint8_t', 'keyIndex')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetKeyId(uint64_t keySrc, uint8_t keyIndex) [member function]
    cls.add_method('SetKeyId', 
                   'void', 
                   [param('uint64_t', 'keySrc'), param('uint8_t', 'keyIndex')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetKeyIdMode(uint8_t keyIdMode) [member function]
    cls.add_method('SetKeyIdMode', 
                   'void', 
                   [param('uint8_t', 'keyIdMode')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetNoAckReq() [member function]
    cls.add_method('SetNoAckReq', 
                   'void', 
                   [])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetNoFrmPend() [member function]
    cls.add_method('SetNoFrmPend', 
                   'void', 
                   [])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetNoPanIdComp() [member function]
    cls.add_method('SetNoPanIdComp', 
                   'void', 
                   [])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetPanIdComp() [member function]
    cls.add_method('SetPanIdComp', 
                   'void', 
                   [])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSecControl(uint8_t secLevel) [member function]
    cls.add_method('SetSecControl', 
                   'void', 
                   [param('uint8_t', 'secLevel')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSecCtrlReserved(uint8_t res) [member function]
    cls.add_method('SetSecCtrlReserved', 
                   'void', 
                   [param('uint8_t', 'res')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSecDisable() [member function]
    cls.add_method('SetSecDisable', 
                   'void', 
                   [])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSecEnable() [member function]
    cls.add_method('SetSecEnable', 
                   'void', 
                   [])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSecLevel(uint8_t secLevel) [member function]
    cls.add_method('SetSecLevel', 
                   'void', 
                   [param('uint8_t', 'secLevel')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSeqNum(uint8_t seqNum) [member function]
    cls.add_method('SetSeqNum', 
                   'void', 
                   [param('uint8_t', 'seqNum')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSrcAddrFields(uint16_t panId, ns3::Mac16Address addr) [member function]
    cls.add_method('SetSrcAddrFields', 
                   'void', 
                   [param('uint16_t', 'panId'), param('ns3::Mac16Address', 'addr')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSrcAddrFields(uint16_t panId, ns3::Mac64Address addr) [member function]
    cls.add_method('SetSrcAddrFields', 
                   'void', 
                   [param('uint16_t', 'panId'), param('ns3::Mac64Address', 'addr')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetSrcAddrMode(uint8_t addrMode) [member function]
    cls.add_method('SetSrcAddrMode', 
                   'void', 
                   [param('uint8_t', 'addrMode')])
    ## snow-mac-header.h (module 'snow'): void ns3::snowMacHeader::SetType(ns3::snowMacHeader::snowMacType wpanMacType) [member function]
    cls.add_method('SetType', 
                   'void', 
                   [param('ns3::snowMacHeader::snowMacType', 'wpanMacType')])
    return
...
def register_Ns3SimpleRefCount__Ns3snowInterferenceHelper_Ns3Empty_Ns3DefaultDeleter__lt__ns3snowInterferenceHelper__gt___methods(root_module, cls):
    ## simple-ref-count.h (module 'core'): ns3::SimpleRefCount<ns3::snowInterferenceHelper, ns3::empty, ns3::DefaultDeleter<ns3::snowInterferenceHelper>>::SimpleRefCount() [constructor]
    cls.add_constructor([])
    ## simple-ref-count.h (module 'core'): ns3::SimpleRefCount<ns3::snowInterferenceHelper, ns3::empty, ns3::DefaultDeleter<ns3::snowInterferenceHelper>>::SimpleRefCount(ns3::SimpleRefCount<ns3::snowInterferenceHelper, ns3::empty, ns3::DefaultDeleter<ns3::snowInterferenceHelper>> const & o) [constructor]
    cls.add_constructor([param('ns3::SimpleRefCount< ns3::snowInterferenceHelper, ns3::empty, ns3::DefaultDeleter< ns3::snowInterferenceHelper > > const &', 'o')])
    return
...
def register_Ns3BeaconPayloadHeader_methods(root_module, cls):
    ## snow-mac-pl-headers.h (module 'snow'): ns3::BeaconPayloadHeader::BeaconPayloadHeader(ns3::BeaconPayloadHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::BeaconPayloadHeader const &', 'arg0')])
    ## snow-mac-pl-headers.h (module 'snow'): ns3::BeaconPayloadHeader::BeaconPayloadHeader() [constructor]
    cls.add_constructor([])
    ## snow-mac-pl-headers.h (module 'snow'): uint32_t ns3::BeaconPayloadHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): ns3::GtsFields ns3::BeaconPayloadHeader::GetGtsFields() const [member function]
    cls.add_method('GetGtsFields', 
                   'ns3::GtsFields', 
                   [], 
                   is_const=True)
    ## snow-mac-pl-headers.h (module 'snow'): ns3::TypeId ns3::BeaconPayloadHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): ns3::PendingAddrFields ns3::BeaconPayloadHeader::GetPndAddrFields() const [member function]
    cls.add_method('GetPndAddrFields', 
                   'ns3::PendingAddrFields', 
                   [], 
                   is_const=True)
    ## snow-mac-pl-headers.h (module 'snow'): uint32_t ns3::BeaconPayloadHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): ns3::SuperframeField ns3::BeaconPayloadHeader::GetSuperframeSpecField() const [member function]
    cls.add_method('GetSuperframeSpecField', 
                   'ns3::SuperframeField', 
                   [], 
                   is_const=True)
    ## snow-mac-pl-headers.h (module 'snow'): static ns3::TypeId ns3::BeaconPayloadHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-mac-pl-headers.h (module 'snow'): void ns3::BeaconPayloadHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): void ns3::BeaconPayloadHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): void ns3::BeaconPayloadHeader::SetGtsFields(ns3::GtsFields gtsFields) [member function]
    cls.add_method('SetGtsFields', 
                   'void', 
                   [param('ns3::GtsFields', 'gtsFields')])
    ## snow-mac-pl-headers.h (module 'snow'): void ns3::BeaconPayloadHeader::SetPndAddrFields(ns3::PendingAddrFields pndAddrFields) [member function]
    cls.add_method('SetPndAddrFields', 
                   'void', 
                   [param('ns3::PendingAddrFields', 'pndAddrFields')])
    ## snow-mac-pl-headers.h (module 'snow'): void ns3::BeaconPayloadHeader::SetSuperframeSpecField(ns3::SuperframeField sfrmField) [member function]
...
def register_Ns3CallbackImplBase_methods(root_module, cls):
    ...
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, template_parameters=['ns3::snowPhyEnumeration'], visibility='protected')
    ## callback.h (module 'core'): static std::string ns3::CallbackImplBase::GetCppTypeid() [member function]
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, template_parameters=['ns3::snowMacState'], visibility='protected')
    ## callback.h (module 'core'): static std::string ns3::CallbackImplBase::GetCppTypeid() [member function]
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
...
def register_Ns3CommandPayloadHeader_methods(root_module, cls):
    ## snow-mac-pl-headers.h (module 'snow'): ns3::CommandPayloadHeader::CommandPayloadHeader(ns3::CommandPayloadHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::CommandPayloadHeader const &', 'arg0')])
    ## snow-mac-pl-headers.h (module 'snow'): ns3::CommandPayloadHeader::CommandPayloadHeader() [constructor]
    cls.add_constructor([])
    ## snow-mac-pl-headers.h (module 'snow'): ns3::CommandPayloadHeader::CommandPayloadHeader(ns3::CommandPayloadHeader::MacCommand macCmd) [constructor]
    cls.add_constructor([param('ns3::CommandPayloadHeader::MacCommand', 'macCmd')])
    ## snow-mac-pl-headers.h (module 'snow'): uint32_t ns3::CommandPayloadHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): ns3::CommandPayloadHeader::MacCommand ns3::CommandPayloadHeader::GetCommandFrameType() const [member function]
    cls.add_method('GetCommandFrameType', 
                   'ns3::CommandPayloadHeader::MacCommand', 
                   [], 
                   is_const=True)
    ## snow-mac-pl-headers.h (module 'snow'): ns3::TypeId ns3::CommandPayloadHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): uint32_t ns3::CommandPayloadHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): static ns3::TypeId ns3::CommandPayloadHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-mac-pl-headers.h (module 'snow'): void ns3::CommandPayloadHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): void ns3::CommandPayloadHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## snow-mac-pl-headers.h (module 'snow'): void ns3::CommandPayloadHeader::SetCommandFrameType(ns3::CommandPayloadHeader::MacCommand macCmd) [member function]
...
def register_Ns3snowCsmaCa_methods(root_module, cls):
    ## snow-csmaca.h (module 'snow'): static ns3::TypeId ns3::snowCsmaCa::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-csmaca.h (module 'snow'): ns3::snowCsmaCa::snowCsmaCa() [constructor]
    cls.add_constructor([])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetMac(ns3::Ptr<ns3::snowMac> mac) [member function]
    cls.add_method('SetMac', 
                   'void', 
                   [param('ns3::Ptr< ns3::snowMac >', 'mac')])
    ## snow-csmaca.h (module 'snow'): ns3::Ptr<ns3::snowMac> ns3::snowCsmaCa::GetMac() const [member function]
    cls.add_method('GetMac', 
                   'ns3::Ptr< ns3::snowMac >',
                   [], 
                   is_const=True)
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetSlottedCsmaCa() [member function]
    cls.add_method('SetSlottedCsmaCa', 
                   'void', 
                   [])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetUnSlottedCsmaCa() [member function]
    cls.add_method('SetUnSlottedCsmaCa', 
                   'void', 
                   [])
    ## snow-csmaca.h (module 'snow'): bool ns3::snowCsmaCa::IsSlottedCsmaCa() const [member function]
    cls.add_method('IsSlottedCsmaCa', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-csmaca.h (module 'snow'): bool ns3::snowCsmaCa::IsUnSlottedCsmaCa() const [member function]
    cls.add_method('IsUnSlottedCsmaCa', 
                   'bool', 
                   [], 
                   is_const=True)
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetMacMinBE(uint8_t macMinBE) [member function]
    cls.add_method('SetMacMinBE', 
                   'void', 
                   [param('uint8_t', 'macMinBE')])
    ## snow-csmaca.h (module 'snow'): uint8_t ns3::snowCsmaCa::GetMacMinBE() const [member function]
    cls.add_method('GetMacMinBE', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetMacMaxBE(uint8_t macMaxBE) [member function]
    cls.add_method('SetMacMaxBE', 
                   'void', 
                   [param('uint8_t', 'macMaxBE')])
    ## snow-csmaca.h (module 'snow'): uint8_t ns3::snowCsmaCa::GetMacMaxBE() const [member function]
    cls.add_method('GetMacMaxBE', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetMacMaxCSMABackoffs(uint8_t macMaxCSMABackoffs) [member function]
    cls.add_method('SetMacMaxCSMABackoffs', 
                   'void', 
                   [param('uint8_t', 'macMaxCSMABackoffs')])
    ## snow-csmaca.h (module 'snow'): uint8_t ns3::snowCsmaCa::GetMacMaxCSMABackoffs() const [member function]
    cls.add_method('GetMacMaxCSMABackoffs', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetUnitBackoffPeriod(uint64_t unitBackoffPeriod) [member function]
    cls.add_method('SetUnitBackoffPeriod', 
                   'void', 
                   [param('uint64_t', 'unitBackoffPeriod')])
    ## snow-csmaca.h (module 'snow'): uint64_t ns3::snowCsmaCa::GetUnitBackoffPeriod() const [member function]
    cls.add_method('GetUnitBackoffPeriod', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## snow-csmaca.h (module 'snow'): ns3::Time ns3::snowCsmaCa::GetTimeToNextSlot() const [member function]
    cls.add_method('GetTimeToNextSlot', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::Start() [member function]
    cls.add_method('Start', 
                   'void', 
                   [])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::Cancel() [member function]
    cls.add_method('Cancel', 
                   'void', 
                   [])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::RandomBackoffDelay() [member function]
    cls.add_method('RandomBackoffDelay', 
                   'void', 
                   [])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::CanProceed() [member function]
    cls.add_method('CanProceed', 
                   'void', 
                   [])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::RequestCCA() [member function]
    cls.add_method('RequestCCA', 
                   'void', 
                   [])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::DeferCsmaTimeout() [member function]
    cls.add_method('DeferCsmaTimeout', 
                   'void', 
                   [])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::PlmeCcaConfirm(ns3::snowPhyEnumeration status) [member function]
    cls.add_method('PlmeCcaConfirm', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'status')])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetsnowMacTransCostCallback(ns3::snowMacTransCostCallback trans) [member function]
    cls.add_method('SetsnowMacTransCostCallback',
                   'void', 
    ...
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetsnowMacStateCallback(ns3::snowMacStateCallback macState) [member function]
    cls.add_method('SetsnowMacStateCallback',
                   'void', 
                   [param('ns3::Callback< void, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'macState')])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::SetBatteryLifeExtension(bool batteryLifeExtension) [member function]
    cls.add_method('SetBatteryLifeExtension', 
                   'void', 
                   [param('bool', 'batteryLifeExtension')])
    ## snow-csmaca.h (module 'snow'): int64_t ns3::snowCsmaCa::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## snow-csmaca.h (module 'snow'): uint8_t ns3::snowCsmaCa::GetNB() [member function]
    cls.add_method('GetNB', 
                   'uint8_t', 
                   [])
    ## snow-csmaca.h (module 'snow'): bool ns3::snowCsmaCa::GetBatteryLifeExtension() [member function]
    cls.add_method('GetBatteryLifeExtension', 
                   'bool', 
                   [])
    ## snow-csmaca.h (module 'snow'): void ns3::snowCsmaCa::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True, visibility='private')
...
def register_Ns3snowErrorModel_methods(root_module, cls):
    ## snow-error-model.h (module 'snow'): ns3::snowErrorModel::snowErrorModel(ns3::snowErrorModel const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowErrorModel const &', 'arg0')])
    ## snow-error-model.h (module 'snow'): ns3::snowErrorModel::snowErrorModel() [constructor]
    cls.add_constructor([])
    ## snow-error-model.h (module 'snow'): double ns3::snowErrorModel::GetChunkSuccessRate(double snr, uint32_t nbits) const [member function]
    cls.add_method('GetChunkSuccessRate', 
                   'double', 
                   [param('double', 'snr'), param('uint32_t', 'nbits')], 
                   is_const=True)
    ## snow-error-model.h (module 'snow'): static ns3::TypeId ns3::snowErrorModel::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
...
def register_Ns3snowInterferenceHelper_methods(root_module, cls):
    ## snow-interference-helper.h (module 'snow'): ns3::snowInterferenceHelper::snowInterferenceHelper(ns3::Ptr<const ns3::SpectrumModel> spectrumModel) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::SpectrumModel const >', 'spectrumModel')])
    ## snow-interference-helper.h (module 'snow'): bool ns3::snowInterferenceHelper::AddSignal(ns3::Ptr<const ns3::SpectrumValue> signal) [member function]
    cls.add_method('AddSignal', 
                   'bool', 
                   [param('ns3::Ptr< ns3::SpectrumValue const >', 'signal')])
    ## snow-interference-helper.h (module 'snow'): bool ns3::snowInterferenceHelper::RemoveSignal(ns3::Ptr<const ns3::SpectrumValue> signal) [member function]
    cls.add_method('RemoveSignal', 
                   'bool', 
                   [param('ns3::Ptr< ns3::SpectrumValue const >', 'signal')])
    ## snow-interference-helper.h (module 'snow'): void ns3::snowInterferenceHelper::ClearSignals() [member function]
    cls.add_method('ClearSignals', 
                   'void', 
                   [])
    ## snow-interference-helper.h (module 'snow'): ns3::Ptr<ns3::SpectrumValue> ns3::snowInterferenceHelper::GetSignalPsd() const [member function]
    cls.add_method('GetSignalPsd', 
                   'ns3::Ptr< ns3::SpectrumValue >', 
                   [], 
                   is_const=True)
    ## snow-interference-helper.h (module 'snow'): ns3::Ptr<const ns3::SpectrumModel> ns3::snowInterferenceHelper::GetSpectrumModel() const [member function]
...
def register_Ns3snowMac_methods(root_module, cls):
    ## snow-mac.h (module 'snow'): ns3::snowMac::snowMac(ns3::snowMac const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowMac const &', 'arg0')])
    ## snow-mac.h (module 'snow'): ns3::snowMac::snowMac() [constructor]
    cls.add_constructor([])
    ## snow-mac.h (module 'snow'): ns3::snowAssociationStatus ns3::snowMac::GetAssociationStatus() const [member function]
    cls.add_method('GetAssociationStatus', 
                   'ns3::snowAssociationStatus',
                   [], 
                   is_const=True)
    ## snow-mac.h (module 'snow'): ns3::Mac64Address ns3::snowMac::GetExtendedAddress() const [member function]
    cls.add_method('GetExtendedAddress', 
                   'ns3::Mac64Address', 
                   [], 
                   is_const=True)
    ## snow-mac.h (module 'snow'): uint32_t ns3::snowMac::GetIfsSize() [member function]
    cls.add_method('GetIfsSize', 
                   'uint32_t', 
                   [])
    ## snow-mac.h (module 'snow'): uint64_t ns3::snowMac::GetMacAckWaitDuration() const [member function]
    cls.add_method('GetMacAckWaitDuration', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## snow-mac.h (module 'snow'): uint8_t ns3::snowMac::GetMacMaxFrameRetries() const [member function]
    cls.add_method('GetMacMaxFrameRetries', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## snow-mac.h (module 'snow'): uint16_t ns3::snowMac::GetPanId() const [member function]
    cls.add_method('GetPanId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## snow-mac.h (module 'snow'): ns3::Ptr<ns3::snowPhy> ns3::snowMac::GetPhy() [member function]
    cls.add_method('GetPhy', 
                   'ns3::Ptr< ns3::snowPhy >',
                   [])
    ## snow-mac.h (module 'snow'): bool ns3::snowMac::GetRxOnWhenIdle() [member function]
    cls.add_method('GetRxOnWhenIdle', 
                   'bool', 
                   [])
    ## snow-mac.h (module 'snow'): ns3::Mac16Address ns3::snowMac::GetShortAddress() const [member function]
    cls.add_method('GetShortAddress', 
                   'ns3::Mac16Address', 
                   [], 
                   is_const=True)
    ## snow-mac.h (module 'snow'): uint64_t ns3::snowMac::GetTxPacketSymbols() [member function]
    cls.add_method('GetTxPacketSymbols', 
                   'uint64_t', 
                   [])
    ## snow-mac.h (module 'snow'): static ns3::TypeId ns3::snowMac::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-mac.h (module 'snow'): void ns3::snowMac::McpsDataRequest(ns3::McpsDataRequestParams params, ns3::Ptr<ns3::Packet> p) [member function]
    cls.add_method('McpsDataRequest', 
                   'void', 
                   [param('ns3::McpsDataRequestParams', 'params'), param('ns3::Ptr< ns3::Packet >', 'p')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::MlmePollRequest(ns3::MlmePollRequestParams params) [member function]
    cls.add_method('MlmePollRequest', 
                   'void', 
                   [param('ns3::MlmePollRequestParams', 'params')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::MlmeStartRequest(ns3::MlmeStartRequestParams params) [member function]
    cls.add_method('MlmeStartRequest', 
                   'void', 
                   [param('ns3::MlmeStartRequestParams', 'params')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::MlmeSyncRequest(ns3::MlmeSyncRequestParams params) [member function]
    cls.add_method('MlmeSyncRequest', 
                   'void', 
                   [param('ns3::MlmeSyncRequestParams', 'params')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::PdDataConfirm(ns3::snowPhyEnumeration status) [member function]
    cls.add_method('PdDataConfirm', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'status')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::PdDataIndication(uint32_t psduLength, ns3::Ptr<ns3::Packet> p, uint8_t lqi) [member function]
    cls.add_method('PdDataIndication', 
                   'void', 
                   [param('uint32_t', 'psduLength'), param('ns3::Ptr< ns3::Packet >', 'p'), param('uint8_t', 'lqi')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::PlmeCcaConfirm(ns3::snowPhyEnumeration status) [member function]
    cls.add_method('PlmeCcaConfirm', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'status')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::PlmeEdConfirm(ns3::snowPhyEnumeration status, uint8_t energyLevel) [member function]
    cls.add_method('PlmeEdConfirm', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'status'), param('uint8_t', 'energyLevel')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::PlmeGetAttributeConfirm(ns3::snowPhyEnumeration status, ns3::snowPibAttributeIdentifier id, ns3::snowPhyPibAttributes * attribute) [member function]
    cls.add_method('PlmeGetAttributeConfirm', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'status'), param('ns3::snowPibAttributeIdentifier', 'id'), param('ns3::snowPhyPibAttributes *', 'attribute')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::PlmeSetAttributeConfirm(ns3::snowPhyEnumeration status, ns3::snowPibAttributeIdentifier id) [member function]
    cls.add_method('PlmeSetAttributeConfirm', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'status'), param('ns3::snowPibAttributeIdentifier', 'id')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::PlmeSetTRXStateConfirm(ns3::snowPhyEnumeration status) [member function]
    cls.add_method('PlmeSetTRXStateConfirm', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'status')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::PrintTransmitQueueSize() [member function]
    cls.add_method('PrintTransmitQueueSize', 
                   'void', 
                   [])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetAssociatedCoor(ns3::Mac16Address mac) [member function]
    cls.add_method('SetAssociatedCoor', 
                   'void', 
                   [param('ns3::Mac16Address', 'mac')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetAssociatedCoor(ns3::Mac64Address mac) [member function]
    cls.add_method('SetAssociatedCoor', 
                   'void', 
                   [param('ns3::Mac64Address', 'mac')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetAssociationStatus(ns3::snowAssociationStatus status) [member function]
    cls.add_method('SetAssociationStatus', 
                   'void', 
                   [param('ns3::snowAssociationStatus', 'status')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetCsmaCa(ns3::Ptr<ns3::snowCsmaCa> csmaCa) [member function]
    cls.add_method('SetCsmaCa', 
                   'void', 
                   [param('ns3::Ptr< ns3::snowCsmaCa >', 'csmaCa')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetExtendedAddress(ns3::Mac64Address address) [member function]
    cls.add_method('SetExtendedAddress', 
                   'void', 
                   [param('ns3::Mac64Address', 'address')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetsnowMacState(ns3::snowMacState macState) [member function]
    cls.add_method('SetsnowMacState',
                   'void', 
                   [param('ns3::snowMacState', 'macState')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetMacMaxFrameRetries(uint8_t retries) [member function]
    cls.add_method('SetMacMaxFrameRetries', 
                   'void', 
                   [param('uint8_t', 'retries')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetMcpsDataConfirmCallback(ns3::McpsDataConfirmCallback c) [member function]
    ...
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetMcpsDataIndicationCallback(ns3::McpsDataIndicationCallback c) [member function]
    ...
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetMlmeBeaconNotifyIndicationCallback(ns3::MlmeBeaconNotifyIndicationCallback c) [member function]
    ...
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetMlmePollConfirmCallback(ns3::MlmePollConfirmCallback c) [member function]
    ...
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetMlmeStartConfirmCallback(ns3::MlmeStartConfirmCallback c) [member function]
    ...
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetMlmeSyncLossIndicationCallback(ns3::MlmeSyncLossIndicationCallback c) [member function]
    ...
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetPanId(uint16_t panId) [member function]
    cls.add_method('SetPanId', 
                   'void', 
                   [param('uint16_t', 'panId')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetPhy(ns3::Ptr<ns3::snowPhy> phy) [member function]
    cls.add_method('SetPhy', 
                   'void', 
                   [param('ns3::Ptr< ns3::snowPhy >', 'phy')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetRxOnWhenIdle(bool rxOnWhenIdle) [member function]
    cls.add_method('SetRxOnWhenIdle', 
                   'void', 
                   [param('bool', 'rxOnWhenIdle')])
    ## snow-mac.h (module 'snow'): void ns3::snowMac::SetShortAddress(ns3::Mac16Address address) [member function]
    cls.add_method('SetShortAddress', 
                   'void', 
                   [param('ns3::Mac16Address', 'address')])
    ## snow-mac.h (module 'snow'): bool ns3::snowMac::isCoordDest() [member function]
    cls.add_method('isCoordDest', 
                   'bool', 
                   [])
    ## snow-mac.h (module 'snow'): bool ns3::snowMac::isTxAckReq() [member function]
    cls.add_method('isTxAckReq', 
                   'bool', 
                   [])
    ## snow-mac.h (module 'snow'): ns3::snowMac::aBaseSlotDuration [variable]
    cls.add_static_attribute('aBaseSlotDuration', 'uint32_t const', is_const=True)
    ## snow-mac.h (module 'snow'): ns3::snowMac::aBaseSuperframeDuration [variable]
    cls.add_static_attribute('aBaseSuperframeDuration', 'uint32_t const', is_const=True)
    ## snow-mac.h (module 'snow'): ns3::snowMac::aMaxLostBeacons [variable]
    cls.add_static_attribute('aMaxLostBeacons', 'uint32_t const', is_const=True)
    ## snow-mac.h (module 'snow'): ns3::snowMac::aMaxSIFSFrameSize [variable]
    cls.add_static_attribute('aMaxSIFSFrameSize', 'uint32_t const', is_const=True)
    ## snow-mac.h (module 'snow'): ns3::snowMac::aMinMPDUOverhead [variable]
    cls.add_static_attribute('aMinMPDUOverhead', 'uint32_t const', is_const=True)
    ## snow-mac.h (module 'snow'): ns3::snowMac::aNumSuperframeSlots [variable]
    cls.add_static_attribute('aNumSuperframeSlots', 'uint32_t const', is_const=True)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_beaconInterval [variable]
    cls.add_instance_attribute('m_beaconInterval', 'uint32_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_beaconTrackingOn [variable]
    cls.add_instance_attribute('m_beaconTrackingOn', 'bool', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_deviceCapability [variable]
    cls.add_instance_attribute('m_deviceCapability', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_fnlCapSlot [variable]
    cls.add_instance_attribute('m_fnlCapSlot', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_ifs [variable]
    cls.add_instance_attribute('m_ifs', 'uint32_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_incomingBeaconInterval [variable]
    cls.add_instance_attribute('m_incomingBeaconInterval', 'uint32_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_incomingBeaconOrder [variable]
    cls.add_instance_attribute('m_incomingBeaconOrder', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_incomingFnlCapSlot [variable]
    cls.add_instance_attribute('m_incomingFnlCapSlot', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_incomingSuperframeDuration [variable]
    cls.add_instance_attribute('m_incomingSuperframeDuration', 'uint32_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_incomingSuperframeOrder [variable]
    cls.add_instance_attribute('m_incomingSuperframeOrder', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macAutoRequest [variable]
    cls.add_instance_attribute('m_macAutoRequest', 'bool', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macBeaconOrder [variable]
    cls.add_instance_attribute('m_macBeaconOrder', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macBeaconRxTime [variable]
    cls.add_instance_attribute('m_macBeaconRxTime', 'ns3::Time', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macBeaconTxTime [variable]
    cls.add_instance_attribute('m_macBeaconTxTime', 'ns3::Time', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macBsn [variable]
    cls.add_instance_attribute('m_macBsn', 'ns3::SequenceNumber8', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macCoordExtendedAddress [variable]
    cls.add_instance_attribute('m_macCoordExtendedAddress', 'ns3::Mac64Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macCoordShortAddress [variable]
    cls.add_instance_attribute('m_macCoordShortAddress', 'ns3::Mac16Address', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macDsn [variable]
    cls.add_instance_attribute('m_macDsn', 'ns3::SequenceNumber8', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macLIFSPeriod [variable]
    cls.add_instance_attribute('m_macLIFSPeriod', 'uint32_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macMaxFrameRetries [variable]
    cls.add_instance_attribute('m_macMaxFrameRetries', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macPanId [variable]
    cls.add_instance_attribute('m_macPanId', 'uint16_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macPromiscuousMode [variable]
    cls.add_instance_attribute('m_macPromiscuousMode', 'bool', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macRxOnWhenIdle [variable]
    cls.add_instance_attribute('m_macRxOnWhenIdle', 'bool', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macSIFSPeriod [variable]
    cls.add_instance_attribute('m_macSIFSPeriod', 'uint32_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macSuperframeOrder [variable]
    cls.add_instance_attribute('m_macSuperframeOrder', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macSyncSymbolOffset [variable]
    cls.add_instance_attribute('m_macSyncSymbolOffset', 'uint64_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_macTransactionPersistanceTime [variable]
    cls.add_instance_attribute('m_macTransactionPersistanceTime', 'uint16_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_numLostBeacons [variable]
    cls.add_instance_attribute('m_numLostBeacons', 'uint8_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_panCoor [variable]
    cls.add_instance_attribute('m_panCoor', 'bool', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_rxBeaconSymbols [variable]
    cls.add_instance_attribute('m_rxBeaconSymbols', 'uint64_t', is_const=False)
    ## snow-mac.h (module 'snow'): ns3::snowMac::m_superframeDuration [variable]
    cls.add_instance_attribute('m_superframeDuration', 'uint32_t', is_const=False)
    ## snow-mac.h (module 'snow'): void ns3::snowMac::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True, visibility='protected')
    ## snow-mac.h (module 'snow'): void ns3::snowMac::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   is_virtual=True, visibility='protected')
...
def register_Ns3snowMacTrailer_methods(root_module, cls):
    ## snow-mac-trailer.h (module 'snow'): ns3::snowMacTrailer::snowMacTrailer(ns3::snowMacTrailer const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowMacTrailer const &', 'arg0')])
    ## snow-mac-trailer.h (module 'snow'): ns3::snowMacTrailer::snowMacTrailer() [constructor]
    cls.add_constructor([])
    ## snow-mac-trailer.h (module 'snow'): bool ns3::snowMacTrailer::CheckFcs(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('CheckFcs', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## snow-mac-trailer.h (module 'snow'): uint32_t ns3::snowMacTrailer::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## snow-mac-trailer.h (module 'snow'): void ns3::snowMacTrailer::EnableFcs(bool enable) [member function]
    cls.add_method('EnableFcs', 
                   'void', 
                   [param('bool', 'enable')])
    ## snow-mac-trailer.h (module 'snow'): uint16_t ns3::snowMacTrailer::GetFcs() const [member function]
    cls.add_method('GetFcs', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## snow-mac-trailer.h (module 'snow'): ns3::TypeId ns3::snowMacTrailer::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-mac-trailer.h (module 'snow'): uint32_t ns3::snowMacTrailer::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-mac-trailer.h (module 'snow'): static ns3::TypeId ns3::snowMacTrailer::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-mac-trailer.h (module 'snow'): bool ns3::snowMacTrailer::IsFcsEnabled() [member function]
    cls.add_method('IsFcsEnabled', 
                   'bool', 
                   [])
    ## snow-mac-trailer.h (module 'snow'): void ns3::snowMacTrailer::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## snow-mac-trailer.h (module 'snow'): void ns3::snowMacTrailer::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## snow-mac-trailer.h (module 'snow'): void ns3::snowMacTrailer::SetFcs(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetFcs', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## snow-mac-trailer.h (module 'snow'): ns3::snowMacTrailer::snow_MAC_FCS_LENGTH [variable]
    cls.add_static_attribute('snow_MAC_FCS_LENGTH', 'uint16_t const', is_const=True)
    return

def register_Ns3snowPhy_methods(root_module, cls):
    ## snow-phy.h (module 'snow'): static ns3::TypeId ns3::snowPhy::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-phy.h (module 'snow'): ns3::snowPhy::aMaxPhyPacketSize [variable]
    cls.add_static_attribute('aMaxPhyPacketSize', 'uint32_t const', is_const=True)
    ## snow-phy.h (module 'snow'): ns3::snowPhy::aTurnaroundTime [variable]
    cls.add_static_attribute('aTurnaroundTime', 'uint32_t const', is_const=True)
    ## snow-phy.h (module 'snow'): ns3::snowPhy::snowPhy() [constructor]
    cls.add_constructor([])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetMobility(ns3::Ptr<ns3::MobilityModel> m) [member function]
    cls.add_method('SetMobility', 
                   'void', 
                   [param('ns3::Ptr< ns3::MobilityModel >', 'm')], 
                   is_virtual=True)
    ## snow-phy.h (module 'snow'): ns3::Ptr<ns3::MobilityModel> ns3::snowPhy::GetMobility() const [member function]
    cls.add_method('GetMobility', 
                   'ns3::Ptr< ns3::MobilityModel >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetChannel(ns3::Ptr<ns3::SpectrumChannel> c) [member function]
    cls.add_method('SetChannel', 
                   'void', 
                   [param('ns3::Ptr< ns3::SpectrumChannel >', 'c')], 
                   is_virtual=True)
    ## snow-phy.h (module 'snow'): ns3::Ptr<ns3::SpectrumChannel> ns3::snowPhy::GetChannel() [member function]
    cls.add_method('GetChannel', 
                   'ns3::Ptr< ns3::SpectrumChannel >', 
                   [])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetDevice(ns3::Ptr<ns3::NetDevice> d) [member function]
    cls.add_method('SetDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'd')], 
                   is_virtual=True)
    ## snow-phy.h (module 'snow'): ns3::Ptr<ns3::NetDevice> ns3::snowPhy::GetDevice() const [member function]
    cls.add_method('GetDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetAntenna(ns3::Ptr<ns3::AntennaModel> a) [member function]
    cls.add_method('SetAntenna', 
                   'void', 
                   [param('ns3::Ptr< ns3::AntennaModel >', 'a')])
    ## snow-phy.h (module 'snow'): ns3::Ptr<ns3::Object> ns3::snowPhy::GetAntenna() const [member function]
    cls.add_method('GetAntenna', 
                   'ns3::Ptr< ns3::Object >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-phy.h (module 'snow'): ns3::Ptr<const ns3::SpectrumModel> ns3::snowPhy::GetRxSpectrumModel() const [member function]
    cls.add_method('GetRxSpectrumModel', 
                   'ns3::Ptr< ns3::SpectrumModel const >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetTxPowerSpectralDensity(ns3::Ptr<ns3::SpectrumValue> txPsd) [member function]
    cls.add_method('SetTxPowerSpectralDensity', 
                   'void', 
                   [param('ns3::Ptr< ns3::SpectrumValue >', 'txPsd')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetNoisePowerSpectralDensity(ns3::Ptr<const ns3::SpectrumValue> noisePsd) [member function]
    cls.add_method('SetNoisePowerSpectralDensity', 
                   'void', 
                   [param('ns3::Ptr< ns3::SpectrumValue const >', 'noisePsd')])
    ## snow-phy.h (module 'snow'): ns3::Ptr<const ns3::SpectrumValue> ns3::snowPhy::GetNoisePowerSpectralDensity() [member function]
    cls.add_method('GetNoisePowerSpectralDensity', 
                   'ns3::Ptr< ns3::SpectrumValue const >', 
                   [])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::StartRx(ns3::Ptr<ns3::SpectrumSignalParameters> params) [member function]
    cls.add_method('StartRx', 
                   'void', 
                   [param('ns3::Ptr< ns3::SpectrumSignalParameters >', 'params')], 
                   is_virtual=True)
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::PdDataRequest(uint32_t const psduLength, ns3::Ptr<ns3::Packet> p) [member function]
    cls.add_method('PdDataRequest', 
                   'void', 
                   [param('uint32_t const', 'psduLength'), param('ns3::Ptr< ns3::Packet >', 'p')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::PlmeCcaRequest() [member function]
    cls.add_method('PlmeCcaRequest', 
                   'void', 
                   [])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::PlmeEdRequest() [member function]
    cls.add_method('PlmeEdRequest', 
                   'void', 
                   [])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::PlmeGetAttributeRequest(ns3::snowPibAttributeIdentifier id) [member function]
    cls.add_method('PlmeGetAttributeRequest', 
                   'void', 
                   [param('ns3::snowPibAttributeIdentifier', 'id')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::PlmeSetTRXStateRequest(ns3::snowPhyEnumeration state) [member function]
    cls.add_method('PlmeSetTRXStateRequest', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'state')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::PlmeSetAttributeRequest(ns3::snowPibAttributeIdentifier id, ns3::snowPhyPibAttributes * attribute) [member function]
    cls.add_method('PlmeSetAttributeRequest', 
                   'void', 
                   [param('ns3::snowPibAttributeIdentifier', 'id'), param('ns3::snowPhyPibAttributes *', 'attribute')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetPdDataIndicationCallback(ns3::PdDataIndicationCallback c) [member function]
    ...
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetPdDataConfirmCallback(ns3::PdDataConfirmCallback c) [member function]
    cls.add_method('SetPdDataConfirmCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'c')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetPlmeCcaConfirmCallback(ns3::PlmeCcaConfirmCallback c) [member function]
    cls.add_method('SetPlmeCcaConfirmCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'c')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetPlmeEdConfirmCallback(ns3::PlmeEdConfirmCallback c) [member function]
    cls.add_method('SetPlmeEdConfirmCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::snowPhyEnumeration, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'c')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetPlmeGetAttributeConfirmCallback(ns3::PlmeGetAttributeConfirmCallback c) [member function]
    cls.add_method('SetPlmeGetAttributeConfirmCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::snowPibAttributeIdentifier, ns3::snowPhyPibAttributes *, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'c')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetPlmeSetTRXStateConfirmCallback(ns3::PlmeSetTRXStateConfirmCallback c) [member function]
    cls.add_method('SetPlmeSetTRXStateConfirmCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'c')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetPlmeSetAttributeConfirmCallback(ns3::PlmeSetAttributeConfirmCallback c) [member function]
    cls.add_method('SetPlmeSetAttributeConfirmCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::snowPhyEnumeration, ns3::snowPibAttributeIdentifier, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'c')])
    ## snow-phy.h (module 'snow'): double ns3::snowPhy::GetDataOrSymbolRate(bool isData) [member function]
    cls.add_method('GetDataOrSymbolRate', 
                   'double', 
                   [param('bool', 'isData')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::SetErrorModel(ns3::Ptr<ns3::snowErrorModel> e) [member function]
    cls.add_method('SetErrorModel', 
                   'void', 
                   [param('ns3::Ptr< ns3::snowErrorModel >', 'e')])
    ## snow-phy.h (module 'snow'): ns3::Ptr<ns3::snowErrorModel> ns3::snowPhy::GetErrorModel() const [member function]
    cls.add_method('GetErrorModel', 
                   'ns3::Ptr< ns3::snowErrorModel >',
                   [], 
                   is_const=True)
    ## snow-phy.h (module 'snow'): uint64_t ns3::snowPhy::GetPhySHRDuration() const [member function]
    cls.add_method('GetPhySHRDuration', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## snow-phy.h (module 'snow'): double ns3::snowPhy::GetPhySymbolsPerOctet() const [member function]
    cls.add_method('GetPhySymbolsPerOctet', 
                   'double', 
                   [], 
                   is_const=True)
    ## snow-phy.h (module 'snow'): int64_t ns3::snowPhy::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## snow-phy.h (module 'snow'): void ns3::snowPhy::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True, visibility='private')
...
def register_Ns3snowSpectrumSignalParameters_methods(root_module, cls):
    ## snow-spectrum-signal-parameters.h (module 'snow'): ns3::Ptr<ns3::SpectrumSignalParameters> ns3::snowSpectrumSignalParameters::Copy() [member function]
    cls.add_method('Copy', 
                   'ns3::Ptr< ns3::SpectrumSignalParameters >', 
                   [], 
                   is_virtual=True)
    ## snow-spectrum-signal-parameters.h (module 'snow'): ns3::snowSpectrumSignalParameters::snowSpectrumSignalParameters() [constructor]
    cls.add_constructor([])
    ## snow-spectrum-signal-parameters.h (module 'snow'): ns3::snowSpectrumSignalParameters::snowSpectrumSignalParameters(ns3::snowSpectrumSignalParameters const & p) [constructor]
    cls.add_constructor([param('ns3::snowSpectrumSignalParameters const &', 'p')])
    ## snow-spectrum-signal-parameters.h (module 'snow'): ns3::snowSpectrumSignalParameters::packetBurst [variable]
...
def register_Ns3CallbackImpl__Void_Ns3snowMacState_Ns3snowMacState_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, cls):
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl() [constructor]
    cls.add_constructor([])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl(ns3::CallbackImpl<void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> const & arg0) [constructor]
    cls.add_constructor([param('ns3::CallbackImpl< void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty > const &', 'arg0')])
    ## callback.h (module 'core'): static std::string ns3::CallbackImpl<void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::DoGetTypeid() [member function]
    cls.add_method('DoGetTypeid', 
                   'std::string', 
                   [], 
                   is_static=True)
    ## callback.h (module 'core'): std::string ns3::CallbackImpl<void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::GetTypeid() const [member function]
    cls.add_method('GetTypeid', 
                   'std::string', 
                   [], 
                   is_const=True, is_virtual=True)
    ## callback.h (module 'core'): void ns3::CallbackImpl<void, ns3::snowMacState, ns3::snowMacState, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::operator()(ns3::snowMacState arg0, ns3::snowMacState arg1) [member operator]
    cls.add_method('operator()', 
                   'void', 
                   [param('ns3::snowMacState', 'arg0'), param('ns3::snowMacState', 'arg1')],
                   custom_name='__call__', is_pure_virtual=True, is_virtual=True)
    return

def register_Ns3CallbackImpl__Void_Ns3snowPhyEnumeration_Ns3snowPhyEnumeration_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, cls):
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl() [constructor]
    cls.add_constructor([])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl(ns3::CallbackImpl<void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> const & arg0) [constructor]
    cls.add_constructor([param('ns3::CallbackImpl< void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty > const &', 'arg0')])
    ## callback.h (module 'core'): static std::string ns3::CallbackImpl<void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::DoGetTypeid() [member function]
    cls.add_method('DoGetTypeid', 
                   'std::string', 
                   [], 
                   is_static=True)
    ## callback.h (module 'core'): std::string ns3::CallbackImpl<void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::GetTypeid() const [member function]
    cls.add_method('GetTypeid', 
                   'std::string', 
                   [], 
                   is_const=True, is_virtual=True)
    ## callback.h (module 'core'): void ns3::CallbackImpl<void, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::operator()(ns3::snowPhyEnumeration arg0, ns3::snowPhyEnumeration arg1) [member operator]
    cls.add_method('operator()', 
                   'void', 
                   [param('ns3::snowPhyEnumeration', 'arg0'), param('ns3::snowPhyEnumeration', 'arg1')],
                   custom_name='__call__', is_pure_virtual=True, is_virtual=True)
    return
...
def register_Ns3CallbackImpl__Void_Ns3Time_Ns3snowPhyEnumeration_Ns3snowPhyEnumeration_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, cls):
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl() [constructor]
    cls.add_constructor([])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl(ns3::CallbackImpl<void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> const & arg0) [constructor]
    cls.add_constructor([param('ns3::CallbackImpl< void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty > const &', 'arg0')])
    ## callback.h (module 'core'): static std::string ns3::CallbackImpl<void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::DoGetTypeid() [member function]
    cls.add_method('DoGetTypeid', 
                   'std::string', 
                   [], 
                   is_static=True)
    ## callback.h (module 'core'): std::string ns3::CallbackImpl<void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::GetTypeid() const [member function]
    cls.add_method('GetTypeid', 
                   'std::string', 
                   [], 
                   is_const=True, is_virtual=True)
    ## callback.h (module 'core'): void ns3::CallbackImpl<void, ns3::Time, ns3::snowPhyEnumeration, ns3::snowPhyEnumeration, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::operator()(ns3::Time arg0, ns3::snowPhyEnumeration arg1, ns3::snowPhyEnumeration arg2) [member operator]
    cls.add_method('operator()', 
                   'void', 
                   [param('ns3::Time', 'arg0'), param('ns3::snowPhyEnumeration', 'arg1'), param('ns3::snowPhyEnumeration', 'arg2')],
                   custom_name='__call__', is_pure_virtual=True, is_virtual=True)
    return
...
def register_Ns3snowNetDevice_methods(root_module, cls):
    ## snow-net-device.h (module 'snow'): ns3::snowNetDevice::snowNetDevice(ns3::snowNetDevice const & arg0) [constructor]
    cls.add_constructor([param('ns3::snowNetDevice const &', 'arg0')])
    ## snow-net-device.h (module 'snow'): ns3::snowNetDevice::snowNetDevice() [constructor]
    cls.add_constructor([])
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::AddLinkChangeCallback(ns3::Callback<void, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> callback) [member function]
    cls.add_method('AddLinkChangeCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): int64_t ns3::snowNetDevice::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## snow-net-device.h (module 'snow'): ns3::Address ns3::snowNetDevice::GetAddress() const [member function]
    cls.add_method('GetAddress', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): ns3::Address ns3::snowNetDevice::GetBroadcast() const [member function]
    cls.add_method('GetBroadcast', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): ns3::Ptr<ns3::Channel> ns3::snowNetDevice::GetChannel() const [member function]
    cls.add_method('GetChannel', 
                   'ns3::Ptr< ns3::Channel >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): ns3::Ptr<ns3::snowCsmaCa> ns3::snowNetDevice::GetCsmaCa() const [member function]
    cls.add_method('GetCsmaCa', 
                   'ns3::Ptr< ns3::snowCsmaCa >',
                   [], 
                   is_const=True)
    ## snow-net-device.h (module 'snow'): uint32_t ns3::snowNetDevice::GetIfIndex() const [member function]
    cls.add_method('GetIfIndex', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): ns3::Ptr<ns3::snowMac> ns3::snowNetDevice::GetMac() const [member function]
    cls.add_method('GetMac', 
                   'ns3::Ptr< ns3::snowMac >',
                   [], 
                   is_const=True)
    ## snow-net-device.h (module 'snow'): uint16_t ns3::snowNetDevice::GetMtu() const [member function]
    cls.add_method('GetMtu', 
                   'uint16_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): ns3::Address ns3::snowNetDevice::GetMulticast(ns3::Ipv4Address multicastGroup) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv4Address', 'multicastGroup')], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): ns3::Address ns3::snowNetDevice::GetMulticast(ns3::Ipv6Address addr) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv6Address', 'addr')], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): ns3::Ptr<ns3::Node> ns3::snowNetDevice::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): ns3::Ptr<ns3::snowPhy> ns3::snowNetDevice::GetPhy() const [member function]
    cls.add_method('GetPhy', 
                   'ns3::Ptr< ns3::snowPhy >',
                   [], 
                   is_const=True)
    ## snow-net-device.h (module 'snow'): static ns3::TypeId ns3::snowNetDevice::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::IsBridge() const [member function]
    cls.add_method('IsBridge', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::IsBroadcast() const [member function]
    cls.add_method('IsBroadcast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::IsLinkUp() const [member function]
    cls.add_method('IsLinkUp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::IsMulticast() const [member function]
    cls.add_method('IsMulticast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::IsPointToPoint() const [member function]
    cls.add_method('IsPointToPoint', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::McpsDataIndication(ns3::McpsDataIndicationParams params, ns3::Ptr<ns3::Packet> pkt) [member function]
    cls.add_method('McpsDataIndication', 
                   'void', 
                   [param('ns3::McpsDataIndicationParams', 'params'), param('ns3::Ptr< ns3::Packet >', 'pkt')])
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::NeedsArp() const [member function]
    cls.add_method('NeedsArp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::Send(ns3::Ptr<ns3::Packet> packet, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('Send', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::SendFrom(ns3::Ptr<ns3::Packet> packet, ns3::Address const & source, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('SendFrom', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'source'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetAddress(ns3::Address address) [member function]
    cls.add_method('SetAddress', 
                   'void', 
                   [param('ns3::Address', 'address')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetChannel(ns3::Ptr<ns3::SpectrumChannel> channel) [member function]
    cls.add_method('SetChannel', 
                   'void', 
                   [param('ns3::Ptr< ns3::SpectrumChannel >', 'channel')])
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetCsmaCa(ns3::Ptr<ns3::snowCsmaCa> csmaca) [member function]
    cls.add_method('SetCsmaCa', 
                   'void', 
                   [param('ns3::Ptr< ns3::snowCsmaCa >', 'csmaca')])
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetIfIndex(uint32_t const index) [member function]
    cls.add_method('SetIfIndex', 
                   'void', 
                   [param('uint32_t const', 'index')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetMac(ns3::Ptr<ns3::snowMac> mac) [member function]
    cls.add_method('SetMac', 
                   'void', 
                   [param('ns3::Ptr< ns3::snowMac >', 'mac')])
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::SetMtu(uint16_t const mtu) [member function]
    cls.add_method('SetMtu', 
                   'bool', 
                   [param('uint16_t const', 'mtu')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetPhy(ns3::Ptr<ns3::snowPhy> phy) [member function]
    cls.add_method('SetPhy', 
                   'void', 
                   [param('ns3::Ptr< ns3::snowPhy >', 'phy')])
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetPromiscReceiveCallback(ns3::NetDevice::PromiscReceiveCallback cb) [member function]
    cls.add_method('SetPromiscReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::Address const &, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::SetReceiveCallback(ns3::NetDevice::ReceiveCallback cb) [member function]
    cls.add_method('SetReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## snow-net-device.h (module 'snow'): bool ns3::snowNetDevice::SupportsSendFrom() const [member function]
    cls.add_method('SupportsSendFrom', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True, visibility='private')
    ## snow-net-device.h (module 'snow'): void ns3::snowNetDevice::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   is_virtual=True, visibility='private')

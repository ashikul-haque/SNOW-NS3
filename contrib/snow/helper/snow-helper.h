 ...
 */
#ifndef snow_HELPER_H
#define snow_HELPER_H
...
class snowHelper : public PcapHelperForDevice,
                     public AsciiTraceHelperForDevice
{
public:
  /**
   * \brief Create a snow helper in an empty state.  By default, a
  ...
  /**
   * \brief Create a snow helper in an empty state with either a
   ...
   */
  snowHelper (bool useMultiModelSpectrumChannel);

  virtual ~snowHelper (void);
   ...
   */
  void AddMobility (Ptr<snowPhy> phy, Ptr<MobilityModel> m);

  /**
   * \brief Install a snowNetDevice and the associated structures (e.g., channel) in the nodes.
  ...
  /**
   * Helper to enable all snow log components with one statement
   */
  void EnableLogComponents (void);

  /**
   * \brief Transform the snowPhyEnumeration enumeration into a printable string.
   * \param e the snowPhyEnumeration
   * \return a string
   */
  static std::string snowPhyEnumerationPrinter (snowPhyEnumeration e);

  /**
   * \brief Transform the snowMacState enumeration into a printable string.
   * \param e the snowMacState
   * \return a string
   */
  static std::string snowMacStatePrinter (snowMacState e);
...
private:
   ...
   */
  snowHelper (snowHelper const &);
  /**
   * \brief Copy constructor - defined and not implemented.
   * \returns
   */
  snowHelper& operator= (snowHelper const &);
  /**

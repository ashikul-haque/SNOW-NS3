 ...
 */
#ifndef snow_INTERFERENCE_HELPER_H
#define snow_INTERFERENCE_HELPER_H
 ...
 * \ingroup snow
 *
 * \brief This class provides helper functions for snow interference handling.
 */
class snowInterferenceHelper : public SimpleRefCount<snowInterferenceHelper>
{
public:
  /**
   ...
   */
  snowInterferenceHelper (Ptr<const SpectrumModel> spectrumModel);

  ~snowInterferenceHelper (void);
...
private:
   ...
   */
  snowInterferenceHelper (snowInterferenceHelper const &);
  /**
   * \brief Copy constructor - defined and not implemented.
   * \returns
   */
  snowInterferenceHelper& operator= (snowInterferenceHelper const &);
  /**
...
#endif /* snow_INTERFERENCE_HELPER_H */

 ...
 */
#ifndef snow_LQI_TAG_H
#define snow_LQI_TAG_H
...
public:
  ...
  /**
   * Create a snowLqiTag with the default LQI 0.
   */
  snowLqiTag (void);

  /**
   * Create a snowLqiTag with the given LQI value.
   * \param lqi The LQI.
   */
  snowLqiTag (uint8_t lqi);

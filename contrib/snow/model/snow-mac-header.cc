...
NS_OBJECT_ENSURE_REGISTERED (snowMacHeader);

// TODO: Test Compressed PAN Id, Security Enabled, different size Key

snowMacHeader::snowMacHeader ()
{
  SetType (snow_MAC_DATA);     // Assume Data frame
...
snowMacHeader::snowMacHeader (enum snowMacType wpanMacType,
                                  uint8_t seqNum)
{
  SetType (wpanMacType);
  SetSeqNum (seqNum);
...
enum snowMacHeader::snowMacType
snowMacHeader::GetType (void) const
{
  switch (m_fctrlFrmType)
    {
    case 0:
      return snow_MAC_BEACON;
      break;
    case 1:
      return snow_MAC_DATA;
      break;
    case 2:
      return snow_MAC_ACKNOWLEDGMENT;
      break;
    case 3:
      return snow_MAC_COMMAND;
      break;
    default:
      return snow_MAC_RESERVED;
    }
}
...
uint16_t
snowMacHeader::GetFrameControl (void) const
{
  uint16_t val = 0;
...
bool
snowMacHeader::IsSecEnable (void) const
{
  return (m_fctrlSecU == 1);
}

bool
snowMacHeader::IsFrmPend (void) const
{
  return (m_fctrlFrmPending == 1);
}

bool
snowMacHeader::IsAckReq (void) const
{
  return (m_fctrlAckReq == 1);
}

bool
snowMacHeader::IsPanIdComp (void) const
{
  return (m_fctrlPanIdComp == 1);
}

uint8_t
snowMacHeader::GetFrmCtrlRes (void) const
{
  return (m_fctrlReserved);
}

uint8_t
snowMacHeader::GetDstAddrMode (void) const
{
  return m_fctrlDstAddrMode;
}

uint8_t
snowMacHeader::GetFrameVer (void) const
{
  return m_fctrlFrmVer;
}

uint8_t
snowMacHeader::GetSrcAddrMode (void) const
{
...
uint8_t
snowMacHeader::GetSeqNum (void) const
{
  return(m_SeqNum);
}
...
uint16_t
snowMacHeader::GetDstPanId (void) const
{
...
Mac16Address
snowMacHeader::GetShortDstAddr (void) const
{
  return(m_addrShortDstAddr);
}
Mac64Address
snowMacHeader::GetExtDstAddr (void) const
{
  return(m_addrExtDstAddr);
}

uint16_t
snowMacHeader::GetSrcPanId (void) const
{
...
Mac16Address
snowMacHeader::GetShortSrcAddr (void) const
{
  return(m_addrShortSrcAddr);
}
Mac64Address
snowMacHeader::GetExtSrcAddr (void) const
{
...
uint8_t
snowMacHeader::GetSecControl (void) const
{
  uint8_t val = 0;
...
uint32_t
snowMacHeader::GetFrmCounter (void) const
{
  return(m_auxFrmCntr);
}

uint8_t
snowMacHeader::GetSecLevel (void) const
{
  return (m_secctrlSecLevel);
}

uint8_t
snowMacHeader::GetKeyIdMode (void) const
{
  return(m_secctrlKeyIdMode);
}

uint8_t
snowMacHeader::GetSecCtrlReserved (void) const
{
  return (m_secctrlReserved);
}

uint32_t
snowMacHeader::GetKeyIdSrc32 (void) const
{
  return(m_auxKeyIdKeySrc32);
}

uint64_t
snowMacHeader::GetKeyIdSrc64 (void) const
{
...
uint8_t
snowMacHeader::GetKeyIdIndex (void) const
{
  return(m_auxKeyIdKeyIndex);
}

bool
snowMacHeader::IsBeacon (void) const
{
  return(m_fctrlFrmType == snow_MAC_BEACON);
}

bool
snowMacHeader::IsData (void) const
{
  return(m_fctrlFrmType == snow_MAC_DATA);
}

bool
snowMacHeader::IsAcknowledgment (void) const
{
  return(m_fctrlFrmType == snow_MAC_ACKNOWLEDGMENT);
}

bool
snowMacHeader::IsCommand (void) const
{
  return(m_fctrlFrmType == snow_MAC_COMMAND);
}



void
snowMacHeader::SetType (enum snowMacType wpanMacType)
{
...
void
snowMacHeader::SetFrameControl (uint16_t frameControl)
{
...
void
snowMacHeader::SetSecEnable (void)
{
  m_fctrlSecU = 1;
}
...
void
snowMacHeader::SetSecDisable (void)
{
  m_fctrlSecU = 0;
}
...
void
snowMacHeader::SetNoFrmPend (void)
{
  m_fctrlFrmPending = 0;
}
...
void
snowMacHeader::SetNoAckReq (void)
{
  m_fctrlAckReq = 0;
}
...
void
snowMacHeader::SetPanIdComp (void)
{
  m_fctrlPanIdComp = 1;
}


void snowMacHeader::SetNoPanIdComp (void)
{
  m_fctrlPanIdComp = 0;
}

void
snowMacHeader::SetFrmCtrlRes (uint8_t res)
{
  m_fctrlReserved = res;
}

void
snowMacHeader::SetDstAddrMode (uint8_t addrMode)
{
...
void
snowMacHeader::SetFrameVer (uint8_t ver)
{
  m_fctrlFrmVer = ver;
}
...
void
snowMacHeader::SetSrcAddrMode (uint8_t addrMode)
{
...
void
snowMacHeader::SetSeqNum (uint8_t seqNum)
{
  m_SeqNum = seqNum;
}

void
snowMacHeader::SetSrcAddrFields (uint16_t panId,
                                   Mac16Address addr)
{
...
void
snowMacHeader::SetDstAddrFields (uint16_t panId,
                                   Mac16Address addr)
{
...
void
snowMacHeader::SetSecControl (uint8_t secControl)
{
...
void
snowMacHeader::SetFrmCounter (uint32_t frmCntr)
{
  m_auxFrmCntr = frmCntr;
}

void
snowMacHeader::SetSecLevel (uint8_t secLevel)
{
  m_secctrlSecLevel = secLevel;
}

void
snowMacHeader::SetKeyIdMode (uint8_t keyIdMode)
{
  m_secctrlKeyIdMode = keyIdMode;
}

void
snowMacHeader::SetSecCtrlReserved (uint8_t res)
{
  m_secctrlReserved = res;
}

void
snowMacHeader::SetKeyId (uint8_t keyIndex)
{
...
void
snowMacHeader::SetKeyId (uint32_t keySrc,
                           uint8_t keyIndex)
{
  m_auxKeyIdKeyIndex = keyIndex;
...
void
snowMacHeader::SetKeyId (uint64_t keySrc,
                           uint8_t keyIndex)
{
  m_auxKeyIdKeyIndex = keyIndex;
...
TypeId
snowMacHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::snowMacHeader")
    .SetParent<Header> ()
    .SetGroupName ("snow")
    .AddConstructor<snowMacHeader> ();
  return tid;
}

TypeId
snowMacHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

void
snowMacHeader::Print (std::ostream &os) const
{
...
uint32_t
snowMacHeader::GetSerializedSize (void) const
{
  /*
...
void
snowMacHeader::Serialize (Buffer::Iterator start) const
{
...
uint32_t
snowMacHeader::Deserialize (Buffer::Iterator start)
{

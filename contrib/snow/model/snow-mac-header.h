...
#ifndef snow_MAC_HEADER_H
#define snow_MAC_HEADER_H
 ...
 */
class snowMacHeader : public Header
{
...
public:
  ...
  enum snowMacType
  {
    snow_MAC_BEACON = 0,         //!< snow_MAC_BEACON
    snow_MAC_DATA = 1,           //!< snow_MAC_DATA
    snow_MAC_ACKNOWLEDGMENT = 2, //!< snow_MAC_ACKNOWLEDGMENT
    snow_MAC_COMMAND = 3,        //!< snow_MAC_COMMAND
    snow_MAC_RESERVED            //!< snow_MAC_RESERVED
  };
   ...
   */
  snowMacHeader (enum snowMacType wpanMacType,      // Data, ACK, Control MAC Header must have
   ...
   */
  enum snowMacType GetType (void) const;
  /**
   ...
   */
  void SetType (enum snowMacType wpanMacType);
  /**

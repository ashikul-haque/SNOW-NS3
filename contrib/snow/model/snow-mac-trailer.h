...
#ifndef snow_MAC_TRAILER_H
#define snow_MAC_TRAILER_H
 ...
 */
class snowMacTrailer : public Trailer
{
public:
  /**
   * The length in octets of the IEEE 802.15.4 MAC FCS field
   */
  static const uint16_t snow_MAC_FCS_LENGTH;

 ...
 */
#ifndef snow_NET_DEVICE_H
#define snow_NET_DEVICE_H
 ...
 * accessing the snowMac pointer to make 802.15.4-specific API calls.
 * As such, this is really just an encapsulating class.
 */
class snowNetDevice : public NetDevice
{
public:
  /**
   * Get the type ID.
   ...
   */
  Ptr<snowCsmaCa> GetCsmaCa (void) const;
  ...
  /**
   * This method indirects to snowMac::SetShortAddress ()

 ...
 */
#ifndef snow_SPECTRUM_VALUE_HELPER_H
#define snow_SPECTRUM_VALUE_HELPER_H
 ...
 * \ingroup snow
 *
 * \brief This class defines all functions to create spectrum model for snow
 */
class snowSpectrumValueHelper
{
public:
  snowSpectrumValueHelper (void);
  virtual ~snowSpectrumValueHelper (void);
...
#endif /*  snow_SPECTRUM_VALUE_HELPER_H */
